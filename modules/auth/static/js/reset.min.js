...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};!function(e){var t={load:{url:"#",method:"POST"},save:{url:"#",method:"POST"},captcha:"/api/captcha",items:[],edit:!1,validation:!0,html:{helpText:'<div class="uk-text-meta">{text}</div>',text:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><br><div class="uk-form-controls"><input class="uk-input {prefix}-form-field{css}" id="{prefix}_{name}" type="{type}" placeholder=""{autofocus}><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div></div>',select:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><br><select{multiple} class="uk-select {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}>{values}</select><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div>',passwordConfirm:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><div class="uk-flex"><div class="{prefix}-field-wrap"><input class="uk-input {prefix}-form-field" id="{prefix}_{name}" type="password" placeholder=""{autofocus}></div><div><input class="uk-input {prefix}-form-field" id="{prefix}_{name}Confirm" type="password" placeholder=""></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div>',captcha:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><div class="uk-grid uk-grid-small"><div><input class="uk-input {prefix}-form-field {prefix}-captcha-field{css}" type="text" placeholder="" id="{prefix}_{name}"{autofocus}></div><div><div class="uk-form-controls"><img class="{prefix}-captcha-img"></div></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}',buttonsWrap:'<div class="{css}">{buttons}{html}</div>',button:'<button class="uk-button {prefix}-form-button{css}" id="{prefix}_{name}" type="{type}">{label}</button>',launcher:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}_btn">{label}:{bullet}</label><div class="uk-flex"><div id="{prefix}_{name}_val" class="{prefix}-{name}-selector" data="{data}">{value}</div><div><button class="uk-button uk-button-default" id="{prefix}_{name}_btn" type="button">{labelBtn}</button></div></div>{helpText}</div>',textarea:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><br><div class="uk-form-controls"><textarea class="uk-textarea {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}></textarea><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div></div>',checkboxlistItem:'<li><label><input class="uk-checkbox {prefix}-{name}-cbx" type="checkbox" data="{title}">&nbsp;&nbsp;{title}</label></li>',checkboxlist:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><div class="uk-panel uk-panel-scrollable{css}" id="{prefix}_{name}_wrap"><ul class="uk-list">{items}</ul></div>{helpText}</div>',valueslistItem:'<div class="uk-flex uk-margin-top {prefix}-{name}-item"><div class="uk-margin-right"><input placeholder="{langParameter}" type="text" class="uk-input formBuilder-valueslist-par" value="{key}"></div><div class="uk-margin-right"><input placeholder="{langValue}" type="text" class="uk-input formBuilder-valueslist-val" value="{value}"></div><div style="padding-top:3px"><button class="uk-icon-button uk-button-danger formBuilder-valueslist-btnDel" uk-icon="icon:minus"></button></div></div>',valueslist:'<div class="uk-flex uk-flex-column"><div class="uk-margin-bottom"><label class="uk-form-label">{label}:{bullet}</label></div><div><button type="button" class="uk-icon-button uk-button-primary formBuilder-valueslist-btnAdd" id="{prefix}_{name}_btnAdd" uk-icon="icon:plus" data-prefix="{prefix}" data-name="{name}"></button></div><div id="{prefix}_{name}_wrap" class="uk-margin-bottom formBuilder-valueslist-wrap">{items}</div></div>',bullet:'&nbsp;<span style="color:red;font-size:120%">&#8226;</span>'},template:{fields:"{fields}",buttons:"{buttons}"},lang:{mandatoryMissing:"Should not be empty",tooShort:"Too short",tooLong:"Too long",invalidFormat:"Doesn't match required format",passwordsNotMatch:"Passwords do not match",parameter:"Parameter",value:"Value"},events:{onInit:function(){},onSaveSubmit:function(){},onSaveValidate:function(){},onSaveSuccess:function(){},onSaveError:function(){},onLoadStart:function(){},onLoadSuccess:function(){},onLoadError:function(){}},formDangerClass:"uk-form-danger"},s=function(s,i){this.element=s,this.settings=e.extend({},t,i),this._defaults=t,this._name="zoiaFormBuilder",this._prefix=this.element.id,this._formTypes=["text","email","password","select","passwordConfirm","captcha","launcher","textarea","checkboxlist","valueslist"],this._saving=!1,this.init()};e.extend(s.prototype,{init:function(){var t="",s="";for(var i in this.settings.items){var a=this.settings.items[i],l="";switch((a.validation&&!this.settings.edit&&a.validation.mandatoryCreate||a.validation&&this.settings.edit&&a.validation.mandatoryEdit)&&(l=this.settings.html.bullet),a.type){case"text":case"email":case"password":t+=this._template(this.settings.html.text,{prefix:this._prefix,name:i,label:a.label,bullet:l,css:a.css?" "+a.css:"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",type:a.type});break;case"launcher":t+=this._template(this.settings.html.launcher,{prefix:this._prefix,name:i,label:a.label,bullet:l,labelBtn:a.labelBtn,data:a.data,value:a.value,css:a.css?" "+a.css:"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):""});break;case"valueslist":var r="";for(var n in a.values)r+=this._template(this.settings.html.valueslistItem,{prefix:this._prefix,name:i,key:n,value:a.values[n],langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});t+=this._template(this.settings.html.valueslist,{prefix:this._prefix,name:i,label:a.label,bullet:l,items:r});break;case"select":var o="";for(var p in a.values)o+='<option value="'+p+'">'+a.values[p]+"</option>";t+=this._template(this.settings.html.select,{prefix:this._prefix,name:i,label:a.label,bullet:l,css:a.css?" "+a.css:"",multiple:a.multiple?" multiple":"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",type:a.type,values:o});break;case"checkboxlist":var u="";for(var c in a.values)u+=this._template(this.settings.html.checkboxlistItem,{prefix:this._prefix,name:i,title:a.values[c]});t+=this._template(this.settings.html.checkboxlist,{prefix:this._prefix,name:i,label:a.label,bullet:l,css:a.css?" "+a.css:"",multiple:a.multiple?" multiple":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",items:u});break;case"passwordConfirm":t+=this._template(this.settings.html.passwordConfirm,{prefix:this._prefix,name:i,label:a.label,bullet:l,css:a.css?" "+a.css:"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",type:"password"});break;case"captcha":t+=this._template(this.settings.html.captcha,{prefix:this._prefix,name:i,css:a.css?" "+a.css:"",label:a.label,bullet:l,helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",autofocus:a.autofocus?"autofocus":""});break;case"textarea":t+=this._template(this.settings.html.textarea,{prefix:this._prefix,name:i,label:a.label,bullet:l,css:a.css?" "+a.css:"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):""});break;case"buttons":for(var d="",f=0;f<a.buttons.length;f++){var h=a.buttons[f];d+=this._template(this.settings.html.button,{css:h.css?" "+h.css:"",prefix:this._prefix,name:h.name||"button"+f,type:h.type||"button",label:h.label||""})+"&nbsp;"}s+=this._template(this.settings.html.buttonsWrap,{prefix:this._prefix,css:a.css?" "+a.css:"",buttons:d,html:a.html?" "+a.html:""})}}e(this.element).html(this._template(this.settings.template.fields,{fields:t})+this._template(this.settings.template.buttons,{buttons:s})),e(".formBuilder-valueslist-btnAdd").unbind(),e(".formBuilder-valueslist-btnAdd").click(function(t){m._valueslistAddFunc(e(this).attr("data-prefix"),e(this).attr("data-name"),"","")}),e(".formBuilder-valueslist-btnDel").unbind(),e(".formBuilder-valueslist-btnDel").click(function(t){t.stopPropagation(),e(this).parent().parent().remove()}),this.settings.events.onInit&&this.settings.events.onInit();var m=this;e(this.element).submit(function(e){e.preventDefault(),m._submit()}),this._captchaInit()},_valueslistAddFunc:function(t,s,i,a,l){var r=this._template(this.settings.html.valueslistItem,{prefix:t,name:s,key:i,value:a,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});e("#"+t+"_"+s+"_wrap").append(r),l||e("."+t+"-"+s+"-item").last().find("div>input:first").focus(),e(".formBuilder-valueslist-btnDel").unbind(),e(".formBuilder-valueslist-btnDel").click(function(t){t.stopPropagation(),e(this).parent().parent().remove()})},setValidation:function(e){this.validation=e},setEditMode:function(e){this.settings.edit=e},clearErrors:function(){e("."+this._prefix+"-form-field").removeClass(this.settings.formDangerClass),e("."+this._prefix+"-error-text").hide()},resetForm:function(){this.clearErrors();e("."+this._prefix+"-form-field").not(".zoiaFormBuilder-no-reset").val(""),e("select."+this._prefix+"-form-field").prop("selectedIndex",0),e(".formBuilder-valueslist-wrap").html("");for(var t in this.settings.items){var s=this.settings.items[t];s.default&&e("#"+this._prefix+"_"+t).val(s.default),"launcher"===s.type&&(e("#"+this._prefix+"_"+t+"_val").html(s.value),e("#"+this._prefix+"_"+t+"_val").attr("data",s.data)),"checkboxlist"===s.type&&e("."+this._prefix+"-"+t+"-cbx").prop("checked",!1)}},serialize:function(){var t=this,s={};for(var i in this.settings.items){var a=this.settings.items[i];-1!==this._formTypes.indexOf(a.type)&&function(){switch(a.type){case"launcher":s[i]={type:a.type,value:e("#"+t._prefix+"_"+i+"_val").html(),id:e("#"+t._prefix+"_"+i+"_val").attr("data")};break;case"checkboxlist":var l=e("."+t._prefix+"-"+i+"-cbx:checked").map(function(){return e(this).attr("data")}).get();s[i]={type:a.type,value:l.join(",")};break;case"valueslist":var r=[];e("."+t._prefix+"-"+i+"-item").each(function(){r.push({p:String(e(this).find("*>.formBuilder-valueslist-par").val()),v:String(e(this).find("*>.formBuilder-valueslist-val").val())})}),s[i]={type:a.type,value:r};break;default:s[i]={type:a.type,value:e("#"+t._prefix+"_"+i).val()}}}()}return s},deserialize:function(t){if(t&&"object"===(void 0===t?"undefined":_typeof(t)))for(var s in this.settings.items)switch(t[s]||(t[s]={id:"",value:""}),t[s].type){case"launcher":e("#"+this._prefix+"_"+s+"_val").html(t[s].value),e("#"+this._prefix+"_"+s+"_val").attr("data",t[s].id);break;case"checkboxlist":var i=t[s].value.split(",");for(var a in i)e('.editForm-groups-cbx[data="'+i[a]+'"]').prop("checked",!0);break;case"valueslist":var l=[];for(var r in t[s].value)l.push(t[s].value[r].p),l.push(t[s].value[r].v);for(e("#"+this._prefix+"_"+s+"_wrap").html("");l.length>0;){var n=l.shift(),o=l.shift();this._valueslistAddFunc(this._prefix,s,n,o,!0)}break;default:e("#"+this._prefix+"_"+s).val(t[s].value||"")}},loadData:function(t){this.settings.events.onLoadStart&&this.settings.events.onLoadStart(),this.resetForm();var s=this;e.ajax({type:this.settings.load.method,url:this.settings.load.url,data:t,cache:!1}).done(function(t){t&&1===t.status?(jQuery.each(t.item,function(t,i){if(e("#"+s._prefix+"_"+t).val(i),s.settings.items[t]&&"checkboxlist"===s.settings.items[t].type&&i){var a=i.split(",");for(var l in a)e('.editForm-groups-cbx[data="'+a[l]+'"]').prop("checked",!0)}if(s.settings.items[t]&&"valueslist"===s.settings.items[t].type&&i){var r=[];for(var o in i)r.push(o),r.push(json[n].values[o]);e("#"+s._prefix+"_"+t+"_wrap").html("");for(var p in json[n].values)s._valueslistAddFunc(s._prefix,t,r.shift(),r.shift())}}),s.settings.events.onLoadSuccess&&s.settings.events.onLoadSuccess(t)):s.settings.events.onLoadError&&s.settings.events.onLoadError(t)}).fail(function(e,t){s.settings.events.onLoadError&&s.settings.events.onLoadError(e,t)})},captchaRefresh:function(){e("."+this._prefix+"-captcha-img").show(),e("."+this._prefix+"-captcha-img").attr("src",this.settings.captcha+"?"+(new Date).getTime()),e("."+this._prefix+"-captcha-field").val("")},_captchaInit:function(){this.captchaRefresh();var t=this;e("img."+this._prefix+"-captcha-img").click(function(){t.captchaRefresh()})},_template:function(e,t){for(var s in t)e=e.replace(new RegExp("{"+s+"}","g"),t[s]);return e},validate:function(t){var s=this,i={},a={};for(var l in this.settings.items){var r=this.settings.items[l];if(-1!==this._formTypes.indexOf(r.type))if("launcher"!==r.type){if("valueslist"!==r.type||"continue"!==function(){if(t[l])return a[l]=t[l].value,"continue";var i=[];return e("."+s._prefix+"-"+l+"-item").each(function(){i.push({p:String(e(this).find("*>.formBuilder-valueslist-par").val()),v:String(e(this).find("*>.formBuilder-valueslist-val").val())})}),a[l]=i,"continue"}())if("checkboxlist"!==r.type){var n=t?t[l]?t[l].value:void 0:e("#"+this._prefix+"_"+l).val();if(r.validation){if(!r.validation.mandatoryEdit&&!n&&this.settings.edit||!r.validation.mandatoryCreate&&!n&&!this.settings.edit)continue;if(r.validation.mandatoryCreate&&!n&&!this.settings.edit){i[l]=this.settings.lang.mandatoryMissing;continue}if(r.validation.mandatoryEdit&&!n&&this.settings.edit){i[l]=this.settings.lang.mandatoryMissing;continue}if(r.validation.process&&"function"==typeof r.validation.process&&(n=r.validation.process(n)),"passwordConfirm"===r.type&&e("#"+this._prefix+"_"+l+"Confirm").val()!==n){i[l]=this.settings.lang.passwordsNotMatch;continue}if(r.validation.length){if(r.validation.length.min&&n.length<r.validation.length.min){i[l]=this.settings.lang.tooShort;continue}if(r.validation.length.max&&n.length>r.validation.length.max){i[l]=this.settings.lang.tooLong;continue}}if(r.validation.regexp&&!n.match(r.validation.regexp)){i[l]=this.settings.lang.invalidFormat;continue}a[l]=n}}else{var o=e("."+this._prefix+"-"+l+"-cbx:checked").map(function(){return e(this).attr("data")}).get();a[l]=t?t[l]?t[l].value:void 0:o.join(",")}}else a[l]=t?t[l]?t[l].id:void 0:e("#"+this._prefix+"_"+l+"_val").attr("data")}return{data:a,errors:i}},errors:function(t){if(Object.keys(t).length>0){var s=!1;for(var i in t)e("#"+this._prefix+"_"+i).addClass(this.settings.formDangerClass),e("#"+this._prefix+"_"+i+"_error_text > span").html(t[i]),e("#"+this._prefix+"_"+i+"_error_text").show(),s||(e("#"+this._prefix+"_"+i).focus(),s=!0),"passwordConfirm"===this.settings.items[i].type&&e("#"+this._prefix+"_"+i+"Confirm").addClass(this.settings.formDangerClass);return!0}return!1},_submit:function(){if(!this._saving){this.settings.events.onSaveSubmit&&this.settings.events.onSaveSubmit(),this.clearErrors();var t=this,s={},i={};if(this.settings.validation){var a=this.validate();if(s=a.data||{},i=a.errors||{},this.errors(i))return;if(this.settings.events.onSaveValidate&&"__stop"===(s=this.settings.events.onSaveValidate(s)||s))return}else if(this.settings.events.onSaveValidate&&"__stop"===(s=this.settings.events.onSaveValidate(s)))return;t._saving=!0,e.ajax({type:this.settings.save.method,url:this.settings.save.url,data:s,cache:!1}).done(function(s){if(t._saving=!1,s&&1===s.status)t.settings.events.onSaveSuccess&&t.settings.events.onSaveSuccess(s);else{if(s.fields)for(var i in s.fields){var a=!1;e("#"+t._prefix+"_"+s.fields[i]).addClass(t.settings.formDangerClass),a||(e("#"+t._prefix+"_"+s.fields[i]).focus(),a=!0)}t.captchaRefresh(),t.settings.events.onSaveError&&t.settings.events.onSaveError(s)}}).fail(function(e,s){t._saving=!1,t.captchaRefresh(),t.settings.events.onSaveError&&t.settings.events.onSaveError(e,s)})}}}),e.fn.zoiaFormBuilder=function(t){var i=void 0;return this.each(function(){(i=e.data(this,"plugin_zoiaFormBuilder"))||(i=new s(this,t),e.data(this,"plugin_zoiaFormBuilder",i))}),i}}(jQuery,window,document),$(document).ready(function(){$("#zoiaReset").zoiaFormBuilder({save:{url:"/api/auth/reset",method:"POST"},formDangerClass:"za-form-danger",template:{fields:"{fields}",buttons:"{buttons}"},html:{helpText:'<div class="za-text-meta">{text}</div>',text:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><div class="za-form-controls"><input class="za-input {prefix}-form-field{css}" id="{prefix}_{name}" type="{type}" placeholder=""{autofocus}><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div></div>',select:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><select class="za-select {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}>{values}</select><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div>',passwordConfirm:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><div class="za-flex"><div class="{prefix}-field-wrap"><input class="za-input {prefix}-form-field" id="{prefix}_{name}" type="password" placeholder=""{autofocus}></div><div><input class="za-input {prefix}-form-field" id="{prefix}_{name}Confirm" type="password" placeholder=""></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div>',captcha:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><div class="za-grid za-grid-small"><div><input class="za-input {prefix}-form-field {prefix}-captcha-field{css}" type="text" placeholder="" id="{prefix}_{name}"{autofocus}></div><div><div class="za-form-controls"><img class="{prefix}-captcha-img"></div></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}',buttonsWrap:'<div class="{css}">{buttons}{html}</div>',button:'<button class="za-button {prefix}-form-button{css}" id="{prefix}_{name}" type="{type}">{label}</button>',launcher:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}_btn">{label}:</label><div class="za-flex"><div id="{prefix}_{name}_val" class="{prefix}-{name}-selector" data="{data}">{value}</div><div><button class="za-button za-button-default" id="{prefix}_{name}_btn" type="button">{labelBtn}</button></div></div>{helpText}</div>',textarea:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><div class="za-form-controls"><textarea class="za-textarea {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}></textarea><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div></div>'},lang:{mandatoryMissing:lang["Should not be empty"],tooShort:lang["Too short"],tooLong:lang["Too long"],invalidFormat:lang["Doesn't match required format"],passwordsNotMatch:lang["Passwords do not match"]},events:{onInit:function(){},onSaveSubmit:function(){},onSaveValidate:function(){$("#zoiaResetSpinner").show(),$("#zoiaReset_btnSave").toggleClass("za-button-primary").toggleClass("za-button-default")},onSaveSuccess:function(){$("#zoiaReset").hide(),$("#requestSuccessful").show(),$("html, body").animate({scrollTop:$("#zoiaReset").offset().top-20},"fast")},onSaveError:function(e){switch($("#zoiaResetSpinner").hide(),$("#zoiaReset_btnSave").toggleClass("za-button-primary").toggleClass("za-button-default"),(e=e||{}).status){case-1:$("#zoiaReset_email_error_text > span").html(lang.fieldErrors.email).show(),$("#zoiaReset_email_error_text").show();break;default:$zUI.notification(lang["Error while setting new password"],{status:"danger"})}}},items:{email:{autofocus:!0,type:"email",label:lang["E-mail"],css:"za-width-medium",helpText:lang["Example: user@domain.com"],validation:{mandatoryCreate:!0,length:{min:6,max:129},regexp:/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,process:function(e){return e.trim().toLowerCase()}}},captcha:{type:"captcha",label:lang.Code,helpText:lang["Digits you see on the picture"],validation:{mandatoryCreate:!0,length:{min:4,max:4},regexp:/^[0-9]+$/,process:function(e){return e.trim()}}},buttons:{type:"buttons",css:"za-margin-top",buttons:[{name:"btnSave",label:'<div za-spinner class="za-margin-right" id="zoiaResetSpinner" style="display:none"></div>'+lang.Reset,css:"za-button-primary",type:"submit"}]}}})});