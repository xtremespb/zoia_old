...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};!function(t){var e={load:{url:"#",method:"POST"},save:{url:"#",method:"POST"},captcha:"/api/captcha",items:[],edit:!1,validation:!0,html:{helpText:'<div class="uk-text-meta">{text}</div>',text:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:</label><br><div class="uk-form-controls"><input class="uk-input {prefix}-form-field{css}" id="{prefix}_{name}" type="{type}" placeholder=""{autofocus}><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div></div>',select:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:</label><br><select{multiple} class="uk-select {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}>{values}</select><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div>',passwordConfirm:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}">{label}:</label><div class="uk-flex"><div class="{prefix}-field-wrap"><input class="uk-input {prefix}-form-field" id="{prefix}_{name}" type="password" placeholder=""{autofocus}></div><div><input class="uk-input {prefix}-form-field" id="{prefix}_{name}Confirm" type="password" placeholder=""></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div>',captcha:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}">{label}:</label><div class="uk-grid uk-grid-small"><div><input class="uk-input {prefix}-form-field {prefix}-captcha-field{css}" type="text" placeholder="" id="{prefix}_{name}"{autofocus}></div><div><div class="uk-form-controls"><img class="{prefix}-captcha-img"></div></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}',buttonsWrap:'<div class="{css}">{buttons}{html}</div>',button:'<button class="uk-button {prefix}-form-button{css}" id="{prefix}_{name}" type="{type}">{label}</button>',launcher:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}_btn">{label}:</label><div class="uk-flex"><div id="{prefix}_{name}_val" class="{prefix}-{name}-selector" data="{data}">{value}</div><div><button class="uk-button uk-button-default" id="{prefix}_{name}_btn" type="button">{labelBtn}</button></div></div>{helpText}</div>',textarea:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:</label><br><div class="uk-form-controls"><textarea class="uk-textarea {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}></textarea><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div></div>',checkboxlistItem:'<li><label><input class="uk-checkbox {prefix}-{name}-cbx" type="checkbox" data="{title}">&nbsp;&nbsp;{title}</label></li>',checkboxlist:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:</label><div class="uk-panel uk-panel-scrollable{css}" id="{prefix}_{name}_wrap"><ul class="uk-list">{items}</ul></div>{helpText}</div>'},template:{fields:"{fields}",buttons:"{buttons}"},lang:{mandatoryMissing:"Should not be empty",tooShort:"Too short",tooLong:"Too long",invalidFormat:"Doesn't match required format",passwordsNotMatch:"Passwords do not match"},events:{onInit:function(){},onSaveSubmit:function(){},onSaveValidate:function(){},onSaveSuccess:function(){},onSaveError:function(){},onLoadStart:function(){},onLoadSuccess:function(){},onLoadError:function(){}},formDangerClass:"uk-form-danger"},s=function(s,a){this.element=s,this.settings=t.extend({},e,a),this._defaults=e,this._name="zoiaFormBuilder",this._prefix=this.element.id,this._formTypes=["text","email","password","select","passwordConfirm","captcha","launcher","textarea","checkboxlist"],this._saving=!1,this.init()};t.extend(s.prototype,{init:function(){var e="",s="";for(var a in this.settings.items){var i=this.settings.items[a];switch(i.type){case"text":case"email":case"password":e+=this._template(this.settings.html.text,{prefix:this._prefix,name:a,label:i.label,css:i.css?" "+i.css:"",autofocus:i.autofocus?"autofocus":"",helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):"",type:i.type});break;case"launcher":e+=this._template(this.settings.html.launcher,{prefix:this._prefix,name:a,label:i.label,labelBtn:i.labelBtn,data:i.data,value:i.value,css:i.css?" "+i.css:"",helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):""});break;case"select":var l="";for(var r in i.values)l+='<option value="'+r+'">'+i.values[r]+"</option>";e+=this._template(this.settings.html.select,{prefix:this._prefix,name:a,label:i.label,css:i.css?" "+i.css:"",multiple:i.multiple?" multiple":"",autofocus:i.autofocus?"autofocus":"",helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):"",type:i.type,values:l});break;case"checkboxlist":var n="";for(var o in i.values)n+=this._template(this.settings.html.checkboxlistItem,{prefix:this._prefix,name:a,title:i.values[o]});e+=this._template(this.settings.html.checkboxlist,{prefix:this._prefix,name:a,label:i.label,css:i.css?" "+i.css:"",multiple:i.multiple?" multiple":"",helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):"",items:n});break;case"passwordConfirm":e+=this._template(this.settings.html.passwordConfirm,{prefix:this._prefix,name:a,label:i.label,css:i.css?" "+i.css:"",autofocus:i.autofocus?"autofocus":"",helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):"",type:"password"});break;case"captcha":e+=this._template(this.settings.html.captcha,{prefix:this._prefix,name:a,css:i.css?" "+i.css:"",label:i.label,helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):"",autofocus:i.autofocus?"autofocus":""});break;case"textarea":e+=this._template(this.settings.html.textarea,{prefix:this._prefix,name:a,label:i.label,css:i.css?" "+i.css:"",autofocus:i.autofocus?"autofocus":"",helpText:i.helpText?this._template(this.settings.html.helpText,{text:i.helpText,prefix:this._prefix}):""});break;case"buttons":for(var p="",c=0;c<i.buttons.length;c++){var f=i.buttons[c];p+=this._template(this.settings.html.button,{css:f.css?" "+f.css:"",prefix:this._prefix,name:f.name||"button"+c,type:f.type||"button",label:f.label||""})+"&nbsp;"}s+=this._template(this.settings.html.buttonsWrap,{prefix:this._prefix,css:i.css?" "+i.css:"",buttons:p,html:i.html?" "+i.html:""})}}t(this.element).html(this._template(this.settings.template.fields,{fields:e})+this._template(this.settings.template.buttons,{buttons:s})),this.settings.events.onInit&&this.settings.events.onInit();var d=this;t(this.element).submit(function(t){t.preventDefault(),d._submit()}),this._captchaInit()},setValidation:function(t){this.validation=t},setEditMode:function(t){this.settings.edit=t},clearErrors:function(){t("."+this._prefix+"-form-field").removeClass(this.settings.formDangerClass),t("."+this._prefix+"-error-text").hide()},resetForm:function(){this.clearErrors();t("."+this._prefix+"-form-field").not(".zoiaFormBuilder-no-reset").val(""),t("select."+this._prefix+"-form-field").prop("selectedIndex",0);for(var e in this.settings.items){var s=this.settings.items[e];s.default&&t("#"+this._prefix+"_"+e).val(s.default),"launcher"===s.type&&(t("#"+this._prefix+"_"+e+"_val").html(s.value),t("#"+this._prefix+"_"+e+"_val").attr("data",s.data)),"checkboxlist"===s.type&&t("."+this._prefix+"-"+e+"-cbx").prop("checked",!1)}},serialize:function(){var e={};for(var s in this.settings.items){var a=this.settings.items[s];if(-1!==this._formTypes.indexOf(a.type))switch(a.type){case"launcher":e[s]={type:a.type,value:t("#"+this._prefix+"_"+s+"_val").html(),id:t("#"+this._prefix+"_"+s+"_val").attr("data")};break;case"checkboxlist":var i=t("."+this._prefix+"-"+s+"-cbx:checked").map(function(){return t(this).attr("data")}).get();e[s]={type:a.type,value:i.join(",")};break;default:e[s]={type:a.type,value:t("#"+this._prefix+"_"+s).val()}}}return e},deserialize:function(e){if(e&&"object"===(void 0===e?"undefined":_typeof(e)))for(var s in this.settings.items)switch(e[s]||(e[s]={id:"",value:""}),e[s].type){case"launcher":t("#"+this._prefix+"_"+s+"_val").html(e[s].value),t("#"+this._prefix+"_"+s+"_val").attr("data",e[s].id);break;case"checkboxlist":var a=e[s].value.split(",");for(var i in a)t('.editForm-groups-cbx[data="'+a[i]+'"]').prop("checked",!0);break;default:t("#"+this._prefix+"_"+s).val(e[s].value||"")}},loadData:function(e){this.settings.events.onLoadStart&&this.settings.events.onLoadStart(),this.resetForm();var s=this;t.ajax({type:this.settings.load.method,url:this.settings.load.url,data:e,cache:!1}).done(function(e){e&&1===e.status?(jQuery.each(e.item,function(e,a){if(t("#"+s._prefix+"_"+e).val(a),s.settings.items[e]&&"checkboxlist"===s.settings.items[e].type&&a){var i=a.split(",");for(var l in i)t('.editForm-groups-cbx[data="'+i[l]+'"]').prop("checked",!0)}}),s.settings.events.onLoadSuccess&&s.settings.events.onLoadSuccess(e)):s.settings.events.onLoadError&&s.settings.events.onLoadError(e)}).fail(function(t,e){s.settings.events.onLoadError&&s.settings.events.onLoadError(t,e)})},captchaRefresh:function(){t("."+this._prefix+"-captcha-img").show(),t("."+this._prefix+"-captcha-img").attr("src",this.settings.captcha+"?"+(new Date).getTime()),t("."+this._prefix+"-captcha-field").val("")},_captchaInit:function(){this.captchaRefresh();var e=this;t("img."+this._prefix+"-captcha-img").click(function(){e.captchaRefresh()})},_template:function(t,e){for(var s in e)t=t.replace(new RegExp("{"+s+"}","g"),e[s]);return t},validate:function(e){var s={},a={};for(var i in this.settings.items){var l=this.settings.items[i];if(-1!==this._formTypes.indexOf(l.type))if("launcher"!==l.type)if("checkboxlist"!==l.type){var r=e?e[i]?e[i].value:void 0:t("#"+this._prefix+"_"+i).val();if(l.validation){if(!l.validation.mandatoryEdit&&!r&&this.settings.edit||!l.validation.mandatoryCreate&&!r&&!this.settings.edit)continue;if(l.validation.mandatoryCreate&&!r&&!this.settings.edit){s[i]=this.settings.lang.mandatoryMissing;continue}if(l.validation.mandatoryEdit&&!r&&this.settings.edit){s[i]=this.settings.lang.mandatoryMissing;continue}if(l.validation.process&&"function"==typeof l.validation.process&&(r=l.validation.process(r)),"passwordConfirm"===l.type&&t("#"+this._prefix+"_"+i+"Confirm").val()!==r){s[i]=this.settings.lang.passwordsNotMatch;continue}if(l.validation.length){if(l.validation.length.min&&r.length<l.validation.length.min){s[i]=this.settings.lang.tooShort;continue}if(l.validation.length.max&&r.length>l.validation.length.max){s[i]=this.settings.lang.tooLong;continue}}if(l.validation.regexp&&!r.match(l.validation.regexp)){s[i]=this.settings.lang.invalidFormat;continue}a[i]=r}}else{var n=t("."+this._prefix+"-"+i+"-cbx:checked").map(function(){return t(this).attr("data")}).get();a[i]=e?e[i]?e[i].value:void 0:n.join(",")}else a[i]=e?e[i]?e[i].id:void 0:t("#"+this._prefix+"_"+i+"_val").attr("data")}return{data:a,errors:s}},errors:function(e){if(Object.keys(e).length>0){var s=!1;for(var a in e)t("#"+this._prefix+"_"+a).addClass(this.settings.formDangerClass),t("#"+this._prefix+"_"+a+"_error_text > span").html(e[a]),t("#"+this._prefix+"_"+a+"_error_text").show(),s||(t("#"+this._prefix+"_"+a).focus(),s=!0),"passwordConfirm"===this.settings.items[a].type&&t("#"+this._prefix+"_"+a+"Confirm").addClass(this.settings.formDangerClass);return!0}return!1},_submit:function(){if(!this._saving){this.settings.events.onSaveSubmit&&this.settings.events.onSaveSubmit(),this.clearErrors();var e=this,s={},a={};if(this.settings.validation){var i=this.validate();if(s=i.data||{},a=i.errors||{},this.errors(a))return;if(this.settings.events.onSaveValidate&&"__stop"===(s=this.settings.events.onSaveValidate(s)||s))return}else if(this.settings.events.onSaveValidate&&"__stop"===(s=this.settings.events.onSaveValidate(s)))return;e._saving=!0,t.ajax({type:this.settings.save.method,url:this.settings.save.url,data:s,cache:!1}).done(function(s){if(e._saving=!1,s&&1===s.status)e.settings.events.onSaveSuccess&&e.settings.events.onSaveSuccess(s);else{if(s.fields)for(var a in s.fields){var i=!1;t("#"+e._prefix+"_"+s.fields[a]).addClass(e.settings.formDangerClass),i||(t("#"+e._prefix+"_"+s.fields[a]).focus(),i=!0)}e.captchaRefresh(),e.settings.events.onSaveError&&e.settings.events.onSaveError(s)}}).fail(function(t,s){e._saving=!1,e.captchaRefresh(),e.settings.events.onSaveError&&e.settings.events.onSaveError(t,s)})}}}),t.fn.zoiaFormBuilder=function(e){var a=void 0;return this.each(function(){(a=t.data(this,"plugin_zoiaFormBuilder"))||(a=new s(this,e),t.data(this,"plugin_zoiaFormBuilder",a))}),a}}(jQuery,window,document),$(document).ready(function(){$("#zoiaAuth").zoiaFormBuilder({save:{url:"/api/auth/login",method:"POST"},formDangerClass:"za-form-danger",template:{fields:"{fields}",buttons:"{buttons}"},html:{helpText:'<div class="za-text-meta">{text}</div>',text:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><div class="za-form-controls"><input class="za-input {prefix}-form-field{css}" id="{prefix}_{name}" type="{type}" placeholder=""{autofocus}><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div></div>',select:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><select class="za-select {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}>{values}</select><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div>',passwordConfirm:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><div class="za-flex"><div class="{prefix}-field-wrap"><input class="za-input {prefix}-form-field" id="{prefix}_{name}" type="password" placeholder=""{autofocus}></div><div><input class="za-input {prefix}-form-field" id="{prefix}_{name}Confirm" type="password" placeholder=""></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div>',captcha:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><div class="za-grid za-grid-small"><div><input class="za-input {prefix}-form-field {prefix}-captcha-field{css}" type="text" placeholder="" id="{prefix}_{name}"{autofocus}></div><div><div class="za-form-controls"><img class="{prefix}-captcha-img"></div></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}',buttonsWrap:'<div class="{css}">{buttons}{html}</div>',button:'<button class="za-button {prefix}-form-button{css}" id="{prefix}_{name}" type="{type}">{label}</button>',launcher:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}_btn">{label}:</label><div class="za-flex"><div id="{prefix}_{name}_val" class="{prefix}-{name}-selector" data="{data}">{value}</div><div><button class="za-button za-button-default" id="{prefix}_{name}_btn" type="button">{labelBtn}</button></div></div>{helpText}</div>',textarea:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><div class="za-form-controls"><textarea class="za-textarea {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}></textarea><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div></div>'},lang:{mandatoryMissing:lang["Should not be empty"],tooShort:lang["Too short"],tooLong:lang["Too long"],invalidFormat:lang["Doesn't match required format"],passwordsNotMatch:lang["Passwords do not match"]},events:{onInit:function(){},onSaveSubmit:function(){},onSaveValidate:function(){$("#zoiaAuthSpinner").show(),$("#zoiaAuth").hide(),$("#zoiaAuth_btnSave").toggleClass("za-button-primary").toggleClass("za-button-default")},onSaveSuccess:function(){$("html, body").animate({scrollTop:$("#zoiaAuth").offset().top-20},"fast"),$("#zoiaAuthSpinner").show(),location.href=redirectURL},onSaveError:function(t){switch($("#zoiaAuthSpinner").hide(),$("#zoiaAuth").show(),$("#zoiaAuth_btnSave").toggleClass("za-button-primary").toggleClass("za-button-default"),(t=t||{}).status){case-1:$("#zoiaAuth_username_error_text > span").html(lang["Invalid username or password"]).show(),$("#zoiaAuth_username_error_text").show(),$("#zoiaAuth_username").addClass("za-form-danger").focus(),$("#zoiaAuth_password").addClass("za-form-danger");break;case-2:$("#zoiaAuth_captcha_error_text > span").html(lang.fieldErrors.captcha).show(),$("#zoiaAuth_captcha_error_text").show();break;default:$zUI.notification(lang["Error while authorizing"],{status:"danger"})}}},items:{username:{type:"text",label:lang.Username,css:"za-width-1-1",autofocus:!0,validation:{mandatoryCreate:!0,length:{min:3,max:20},regexp:/^[A-Za-z0-9_\-]+$/,process:function(t){return t.trim().toLowerCase()}}},password:{type:"password",css:"za-width-1-1",label:lang.Password,validation:{mandatoryCreate:!0,length:{min:5,max:50},process:function(t){return t.trim()}}},captcha:{type:"captcha",label:lang.Code,validation:{mandatoryCreate:!0,length:{min:4,max:4},regexp:/^[0-9]+$/,process:function(t){return t.trim()}}},buttons:{type:"buttons",css:"za-margin-top za-text-center",buttons:[{name:"btnSave",label:'<div za-spinner class="za-margin-right" id="zoiaAuthSpinner" style="display:none"></div>'+lang["Log in"],css:"za-button-primary za-button-large",type:"submit"}]}}})});