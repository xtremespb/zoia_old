...
"use strict";!function(){var c="",r=[],l=void 0,a=void 0,e=void 0,o=void 0,i=void 0,t=void 0,n=void 0,s=void 0,d=void 0,u=void 0,f={d:'<div class="zoia-browse-item zoia-browse-item-d" data="{filename}"><div class="zoia-browse-item-img za-flex za-flex-center za-flex-middle"><span za-icon="icon:folder;ratio:2"></span></div><div class="zoia-browse-item-text"{tooltip}>{filename}</div></div>',f:'<div class="zoia-browse-item zoia-browse-item-f" data="{filename}"><div class="zoia-browse-item-img za-flex za-flex-center za-flex-middle">{innerContent}</div><div class="zoia-browse-item-text"{tooltip}>{filename}</div></div>',o:""},p=function(e,t){for(var a in t)e=e.replace(new RegExp("{"+a+"}","g"),t[a]);return e},z=function(){$(".zoia-browse-ctl-button").attr("disabled",!0),$(".zoia-browse-ctl-refresh, .zoia-browse-ctl-upload, .zoia-browse-ctl-newdir").attr("disabled",!1);var e=$("#zoia-browse-content").getSelected("zoia-browse-item-selected");e.length&&(1===e.length&&($(".zoia-browse-ctl-rename").attr("disabled",!1),$('.zoia-browse-item[data="'+e[0]+'"]').hasClass("zoia-browse-item-f")&&$("#zoiaBrowseSelectBtn").attr("disabled",!1)),$(".zoia-browse-ctl-delete, .zoia-browse-ctl-cut, .zoia-browse-ctl-copy").attr("disabled",!1)),s&&$(".zoia-browse-ctl-paste").attr("disabled",!1),c&&$(".zoia-browse-ctl-up").attr("disabled",!1)},m=function(){l.show(),$("#zoia-browse-content").html(""),$.ajax({type:"POST",url:"/api/pages/browse/list",data:{path:(r.join("/")+"/"+c).replace(/^\//,"")},cache:!1}).done(function(e){if(l.hide(),1===e.status){var t="";for(var a in e.files){var o=e.files[a],i="";14<o.filename.length&&(i=' title="'+o.filename+'" za-tooltip="delay:300"');var n="";if(o.ext&&!o.thumb)switch(o.ext){case"jpg":case"jpeg":case"gif":case"png":n='<span za-icon="icon:image;ratio:2">';break;default:n='<span za-icon="icon:file;ratio:2">'}o.thumb&&(n='<img src="/pages/static/storage/'+(r.join("/")+"/"+c).replace(/^\//,"")+"/___tn_"+o.filename+'" class="zoia-browse-item-thumb">'),t+=p(f[o.type],{filename:o.filename,type:o.type,tooltip:i,innerContent:n})}e.files&&e.files.length||(t='<div style="padding-left:15px">'+lang["No files to display"]+"</div>"),$("#zoia-browse-content").html(t),$(".zoia-browse-item").dblclick(g),$(".zoia-browse-item").on("doubletap",g),$(".zoia-browse-item").shifty({className:"zoia-browse-item-selected",select:function(){z()},unselect:function(){}})}else switch(l.hide(),e.status){case-1:$zUI.notification(lang["Directory doesn't exists"],{status:"danger",timeout:1500});break;default:$zUI.notification(lang["Could not get directory content"],{status:"danger",timeout:1500})}}).fail(function(){$zUI.notification(lang["Could not get directory content"],{status:"danger",timeout:1500})})},g=function(){$(this).hasClass("zoia-browse-item-d")&&(c&&r.push(c),c=$(this).attr("data"),m(),z())},b=function(e){e.preventDefault(),$(".zoia-browse-item").removeClass("zoia-browse-item-selected"),c=0===r.length?"":r.pop(),m(),z()},w=function(){a.show(),$(".zoiaFileDialogTitle").html(lang["New folder"]),$("#zoiaFileDialogInput").focus(),$("#zoiaFileDialogInput").val(""),o="folder"},h=function(){var e=$("#zoia-browse-content").getSelected("zoia-browse-item-selected");return!(!e||0===e.length)&&($(".zoia-browse-ctl-clipboard").removeClass("za-button-secondary"),n=e,t=(r.join("/")+"/"+c).replace(/^\//,""),!0)},v=function(){t!==(r.join("/")+"/"+c).replace(/^\//,"")?s&&(l.show(),$.ajax({type:"POST",url:"/api/pages/browse/paste",data:{pathSource:t,pathDestination:(r.join("/")+"/"+c).replace(/^\//,""),files:n,operation:s},cache:!1}).done(function(e){$(".zoia-browse-ctl-clipboard").removeClass("za-button-secondary"),t=s=n=null,1===e.status?($zUI.notification(lang["Operation was successful"],{status:"success",timeout:1500}),m()):(l.hide(),$zUI.notification(lang["Cannot paste one or more files"],{status:"danger",timeout:1500}))}).fail(function(){l.hide(),$(".zoia-browse-ctl-clipboard").removeClass("za-button-secondary"),t=s=n=null,$zUI.notification(lang["Cannot paste one or more files"],{status:"danger",timeout:1500})})):$zUI.modal.alert(lang["Cannot paste files to the same directory"],{labels:{ok:lang.OK}})},C=function(){var e=$("#zoia-browse-content").getSelected("zoia-browse-item-selected");e&&0!==e.length&&$zUI.modal.confirm(lang["You are going to delete the following file(s)"]+":<br><br>"+e.join(", "),{labels:{ok:lang.OK,cancel:lang.Cancel}}).then(function(){$.ajax({type:"POST",url:"/api/pages/browse/delete",data:{path:(r.join("/")+"/"+c).replace(/^\//,""),files:e},cache:!1}).done(function(e){1===e.status?($zUI.notification(lang["Operation was successful"],{status:"success",timeout:1500}),m()):(l.hide(),$zUI.notification(lang["Error while deleting one or more files"],{status:"danger",timeout:1500}))}).fail(function(){l.hide(),$zUI.notification(lang["Error while deleting one or more files"],{status:"danger",timeout:1500})})})},I=function(){d.splice(0),$("#zoia-upload-files").html("").hide()},U=function(){d.settings.multipart_params={dir:(r.join("/")+"/"+c).replace(/^\//,"")},u=!1,d.start()};$(document).ready(function(){locale=$("#zp_locale").attr("data"),$.getScript("/api/lang/pages/"+locale+".js").done(function(){l=$zUI.modal("#zoiaSpinnerDialog",{bgClose:!1,escClose:!1,stack:!0}),a=$zUI.modal("#zoiaFileDialog",{bgClose:!1,escClose:!1,stack:!0}),e=$zUI.modal("#zoiaUploadDialog",{bgClose:!1,escClose:!1,stack:!0}),$("#zoia-browse-content").click(function(e){"zoia-browse-content"===e.target.id&&($(".zoia-browse-item").removeClass("zoia-browse-item-selected"),z())}),$(".zoia-browse-ctl-up").click(b),$(".zoia-browse-ctl-newdir").click(w),$(".zoia-browse-ctl-delete").click(C),$(".zoia-browse-ctl-upload").click(function(){u=!1,d.splice(0),$("#zoia-upload-files").html("").hide(),e.show()}),$(".zoia-browse-ctl-refresh").click(m),$(".zoia-browse-ctl-copy").click(function(){h()&&(s="copy",z(),$(".zoia-browse-ctl-copy").addClass("za-button-secondary"))}),$(".zoia-browse-ctl-cut").click(function(){h()&&(s="cut",z(),$(".zoia-browse-ctl-cut").addClass("za-button-secondary"))}),$(".zoia-browse-ctl-paste").click(v),$(".zoia-browse-ctl-rename").click(function(){var e,t=$("#zoia-browse-content").getSelected("zoia-browse-item-selected");!t.length||1<t.length||(e=t[0],a.show(),$(".zoiaFileDialogTitle").html(lang.Rename),$("#zoiaFileDialogInput").focus(),$("#zoiaFileDialogInput").val(e),o="rename",i=e)}),$("#zoiaFileDialogForm").submit(function(e){e.preventDefault(),function(){var e=$("#zoiaFileDialogInput").val();if(!e||"string"!=typeof e||40<e.length||!e.match(/^[a-zA-Z0-9_\-\.;\s]+$/))$zUI.notification(lang["Invalid name, please use characters and numbers only"],{status:"danger",timeout:1500});else switch(o){case"folder":a.hide(),l.show(),$.ajax({type:"POST",url:"/api/pages/browse/folder/create",data:{path:(r.join("/")+"/"+c).replace(/^\//,""),name:e},cache:!1}).done(function(e){1===e.status?($zUI.notification(lang["Operation was successful"],{status:"success",timeout:1500}),m()):(l.hide(),$zUI.notification(lang["Error while creating new folder"],{status:"danger",timeout:1500}))}).fail(function(){l.hide(),$zUI.notification(lang["Error while creating new folder"],{status:"danger",timeout:1500})});break;case"rename":a.hide(),l.show(),$.ajax({type:"POST",url:"/api/pages/browse/rename",data:{path:(r.join("/")+"/"+c).replace(/^\//,""),nameOld:i,nameNew:e},cache:!1}).done(function(e){1===e.status?($zUI.notification(lang["Operation was successful"],{status:"success",timeout:1500}),m()):(l.hide(),$zUI.notification(lang["Could not rename selected file"],{status:"danger",timeout:1500}))}).fail(function(){l.hide(),$zUI.notification(lang["Could not rename selected file"],{status:"danger",timeout:1500})})}}()}),$("#btnUploadClear").click(I),$("#btnUpload").click(U),$("#zoiaBrowseCancelBtn").click(function(){window.close()}),$("#zoiaBrowseSelectBtn").click(function(){var e,t,a=$("#zoia-browse-content").getSelected("zoia-browse-item-selected");if(a.length&&1===a.length&&$('.zoia-browse-item[data="'+a[0]+'"]').hasClass("zoia-browse-item-f")){var o=(r.join("/")+"/"+c+"/"+a[0]).replace(/\/\//gm,"");"/"!==o.charAt(0)&&(o="/"+o),o="/pages/static/storage"+o;var i=(e=new RegExp("(?:[?&]|&amp;)"+"CKEditorFuncNum"+"=([^&]+)","i"),(t=window.location.search.match(e))&&1<t.length?t[1]:"");if(window.opener.zoiaCodeMirror){var n=window.opener.zoiaCodeMirror.getDoc(),l=n.getCursor(),s={line:l.line,ch:l.ch};n.replaceRange('<img src="'+o+'" alt="">',s)}else window.opener.CKEDITOR.tools.callFunction(i,o);window.close()}}),(d=new plupload.Uploader({browse_button:"zoia-upload-area",runtimes:"html5,html4",url:"/api/pages/browse/upload",drop_element:"zoia-upload-area",filters:{max_file_size:"100mb"}})).init(),d.bind("FilesAdded",function(e,t){var a="";plupload.each(t,function(e){a+='<div><div class="zoia-upload-files-label">'+e.name+"&nbsp;("+plupload.formatSize(e.size)+')</div><progress id="'+e.id+'" class="za-progress" value="0" max="100"></progress></div>'}),$("#zoia-upload-files").html(a),$("#zoia-upload-files").show()}),d.bind("Error",function(){$zUI.notification(lang["Cannot upload"]+": "+file.name,{status:"danger",timeout:1500})}),d.bind("UploadProgress",function(e,t){$("#"+t.id).attr("value",t.percent)}),d.bind("FileUploaded",function(e,t,a){try{1!==JSON.parse(a.response).status?(u=!0,$zUI.notification(lang["Cannot upload"]+": "+t.name,{status:"danger",timeout:1500})):$("#"+t.id).parent().remove()}catch(e){}}),d.bind("UploadComplete",function(){u||e.hide(),m()}),m(),z()})})}();