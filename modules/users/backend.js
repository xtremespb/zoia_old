...
module.exports = function(app) {
    ...
    let list = async(req, res, next) => {
        try {
            ...
            res.send(await panel.html(req, moduleId, i18n.get().__(locale, 'title'), html, ['/users/static/css/users.css'], ['/zoia/3rdparty/jquery/jquery.history.min.js', '/zoia/core/js/jquery.zoiaTable.js', '/zoia/core/js/shared.js', '/users/static/js/users.js']));
        } catch (e) {
