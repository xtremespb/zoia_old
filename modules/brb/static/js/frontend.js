...
(() => {
    ...
    const commonFormSubmitHandler = (e) => {
        ...
        $.ajax({
            type: 'POST',
            url: '/api/brb/profile/common/save',
            data: {
                realname: realname
            },
            cache: false
    ...
    const passwordFormSubmitHandler = (e) => {
        ...
        $.ajax({
            type: 'POST',
            url: '/api/brb/profile/password/save',
            data: {
    ...
    const email1FormSubmitHandler = (e) => {
        ...
        $.ajax({
            type: 'POST',
            url: '/api/brb/profile/email/step1',
            data: {
                emailNew: emailNew
            },
            cache: false
    ...
    const email2FormSubmitHandler = (e) => {
        ...
        $.ajax({
            type: 'POST',
            url: '/api/brb/profile/email/step2',
            data: {
                code1: code1,
                code2: code2
            },
