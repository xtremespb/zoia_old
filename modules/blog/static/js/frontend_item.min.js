...
"use strict";!function(){var i=void 0,n=void 0,m=void 0,d=void 0,o=void 0,c=void 0,r=function(t,e){for(var a in e)t=t.replace(new RegExp("{"+a+"}","g"),e[a]);return t},s=function(t){var e=1;t.parentId&&(e=parseInt($('.za-comment[data-id="'+t.parentId+'"]').attr("data-level"),10)+1);var a=20*(e-1),n=moment(1e3*parseInt(t.timestamp,10)).locale(i).format("L ["+lang.at+"] LT"),o=r(m,{id:t._id,level:e,offset:a,comment:t.comment,username:t.username,picture:t.picture,timestamp:n});t.parentId?$('.za-comment[data-id="'+t.parentId+'"]').parent().append(o):$("#zoia_comments").append(o)},l=function(t,e){var a=t.level||1;t.parentId&&(a=parseInt($('.za-comment[data-id="'+t.parentId+'"]').attr("data-level"),10)+1);var n=20*(a-1),o=r(d,{id:t._id,level:a,offset:n});return e&&(t.parentId?$('.za-comment[data-id="'+t.parentId+'"]').parent().append(o):$("#zoia_comments").append(o)),o},e=function(t,e){if(!$("#zoia_btn_addcomment_spinner").is(":visible")){e=e||c,$("#zoia_comment").removeClass("za-form-danger");var a=$("#zoia_comment").val().trim();if(!a||512<a.length)return $("#zoia_comment").addClass("za-form-danger").focus();$("#zoia_btn_addcomment_spinner").show(),$.ajax({type:"POST",url:"/api/blog/comments/add",data:{comment:a,parentId:e,postId:n},cache:!1}).done(function(t){$("#zoia_btn_addcomment_spinner").hide(),t&&1===t.status?(s({comment:t.comment,_id:t._id,parentId:e,username:t.username,picture:t.picture,timestamp:t.timestamp}),f(null,"nofocus"),$("html, body").animate({scrollTop:$("#"+t._id).offset().top},200),$("#"+t._id).addClass("zoia-comment-new"),$("#"+t._id).css("background",o),setTimeout(function(){$("#"+t._id).css("background","")},500),$(".zoia-comment-reply").unbind().click(u),$(".zoia-comment-remove").unbind().click(p)):$zUI.notification(t.error?t.error:lang["Could not add your comment"],{status:"danger",timeout:1500})}).fail(function(){$("#zoia_btn_addcomment_spinner").hide(),$zUI.notification(lang["Could not add your comment"],{status:"danger",timeout:1500})})}},u=function(t){t.preventDefault(),$(".zoia-comment-reply").show(),$("#zoia_btn_newcomment").show();var e=$(t.target).attr("data-id"),a=$(".zoia-comment-form").detach();$('.zoia-comment-reply[data-id="'+e+'"]').hide().parent().append(a),c=e,$("#zoia_comment").removeClass("za-form-danger"),$("#zoia_comment").val("").focus()},p=function(t){t.preventDefault();var n=$(t.target).attr("data-id");$zUI.modal.confirm(lang["Are you sure you wish to delete the comment?"],{stack:!0,labels:{ok:lang.OK,cancel:lang.Cancel}}).then(function(){$('a[data-id="'+n+'"]>.za-spinner').show(),$.ajax({type:"POST",url:"/api/blog/comments/remove",data:{commentId:n},cache:!1}).done(function(t){if(t&&1===t.status){var e=$("#"+n).attr("data-level"),a=l({level:e,_id:n},!1);$("#"+n).replaceWith(a)}else $('a[data-id="'+n+'"]>.za-spinner').hide(),$zUI.notification(lang["Could not delete a comment"],{status:"danger",timeout:1500})}).fail(function(){$('a[data-id="'+n+'"]>.za-spinner').hide(),$zUI.notification(lang["Could not delete a comment"],{status:"danger",timeout:1500})})},function(){})},f=function(t,e){$(".zoia-comment-reply").show();var a=$(".zoia-comment-form").detach();$("#zoia_btn_newcomment").parent().prepend(a),$("#zoia_btn_newcomment").hide(),$("#zoia_comment").val(""),c=null,e||$("#zoia_comment").focus()};$(document).ready(function(){i=$("#zp_locale").attr("data"),m=$("#zp_comment").attr("data"),d=$("#zp_comment_removed").attr("data"),o=$("#zp_newCommentHighlight").attr("data"),n=$("#zp_postId").attr("data"),$.getScript("/api/lang/blog/"+i+".js").done(function(){$("#zoia_btn_addcomment").click(e),$("#zoia_btn_newcomment").click(f),$("#zoia_comment").keydown(function(t){t.ctrlKey&&13===t.keyCode&&e()}),$.ajax({type:"POST",url:"/api/blog/comments/load",data:{postId:n},cache:!1}).done(function(t){if(t&&1===t.status){for(var e in t.comments){var a=t.comments[e];a.username=t.usersData[a.userId].username,a.picture=t.usersData[a.userId].picture,a.comment?s(a):l(a,!0)}$(".zoia-comment-reply").unbind().click(u),$(".zoia-comment-remove").unbind().click(p),$("#zoia_comments_loading").hide(),$("#zoia_comments_wrap").show()}}).fail(function(){$("#zoia_comments_loading").hide(),$zUI.notification(lang["Error while loading comments"],{status:"danger",timeout:2500})})})})}();