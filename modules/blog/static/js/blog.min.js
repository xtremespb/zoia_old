...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};!function(_){var i="zoiaFormBuilder",a={load:{url:"#",method:"POST"},save:{url:"#",method:"POST"},captcha:"/api/captcha",items:[],edit:!1,validation:!0,html:{helpText:'<div class="uk-text-meta">{text}</div>',text:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><br><div class="uk-form-controls"><input class="uk-input {prefix}-form-field{css}" id="{prefix}_{name}" type="{type}" placeholder=""{autofocus}><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div></div>',select:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><br><select{multiple} class="uk-select {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}>{values}</select><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div>',passwordConfirm:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><div class="uk-flex"><div class="{prefix}-field-wrap"><input class="uk-input {prefix}-form-field" id="{prefix}_{name}" type="password" placeholder=""{autofocus}></div><div><input class="uk-input {prefix}-form-field" id="{prefix}_{name}Confirm" type="password" placeholder=""></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div>',captcha:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><div class="uk-grid uk-grid-small"><div><input class="uk-input {prefix}-form-field {prefix}-captcha-field{css}" type="text" placeholder="" id="{prefix}_{name}"{autofocus}></div><div><div class="uk-form-controls"><img class="{prefix}-captcha-img"></div></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}',buttonsWrap:'<div class="{css}">{buttons}{html}</div>',button:'<button class="uk-button {prefix}-form-button{css}" id="{prefix}_{name}" type="{type}">{label}</button>',launcher:'<div class="uk-margin"><label class="uk-form-label" for="{prefix}_{name}_btn">{label}:{bullet}</label><div class="uk-flex"><div id="{prefix}_{name}_val" class="{prefix}-{name}-selector" data="{data}">{value}</div><div><button class="uk-button uk-button-default" id="{prefix}_{name}_btn" type="button">{labelBtn}</button></div></div>{helpText}{html}</div>',textarea:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><br><div class="uk-form-controls"><textarea class="uk-textarea {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}></textarea><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="uk-label-danger"></span></div>{helpText}</div></div>',checkboxlistItem:'<li><label><input class="uk-checkbox {prefix}-{name}-cbx" type="checkbox" data="{title}">&nbsp;&nbsp;{title}</label></li>',checkboxlist:'<div class="uk-margin-bottom"><label class="uk-form-label" for="{prefix}_{name}">{label}:{bullet}</label><div class="uk-panel uk-panel-scrollable{css}" id="{prefix}_{name}_wrap"><ul class="uk-list">{items}</ul></div>{helpText}</div>',valueslistItem:'<div class="uk-flex uk-margin-top {prefix}-{name}-item"><div class="uk-margin-right"><input placeholder="{langParameter}" type="text" class="uk-input formBuilder-valueslist-par" value="{key}"></div><div class="uk-margin-right"><input placeholder="{langValue}" type="text" class="uk-input formBuilder-valueslist-val" value="{value}"></div><div style="padding-top:3px"><button class="uk-icon-button uk-button-danger formBuilder-valueslist-btnDel" uk-icon="icon:minus"></button></div></div>',valueslistItemFixed:'<div class="uk-flex uk-margin-top {prefix}-{name}-item"><div class="uk-margin-right">{key}</div><div class="uk-margin-right"><input placeholder="{langValue}" type="text" class="uk-input formBuilder-valueslist-val" value="{value}"></div></div>',valueslist:'<div class="uk-flex uk-flex-column"><div class="uk-margin-bottom"><label class="uk-form-label">{label}:{bullet}</label></div><div><button type="button" class="uk-icon-button uk-button-primary formBuilder-valueslist-btnAdd" id="{prefix}_{name}_btnAdd" uk-icon="icon:plus" data-prefix="{prefix}" data-name="{name}"></button></div><div id="{prefix}_{name}_wrap" class="uk-margin-bottom {prefix}-formBuilder-valueslist-wrap">{items}</div></div>',bullet:'&nbsp;<span style="color:red;font-size:120%">&#8226;</span>'},template:{fields:"{fields}",buttons:"{buttons}"},lang:{mandatoryMissing:"Should not be empty",tooShort:"Too short",tooLong:"Too long",invalidFormat:"Doesn't match required format",passwordsNotMatch:"Passwords do not match",parameter:"Parameter",value:"Value"},events:{onInit:function(){},onSaveSubmit:function(){},onSaveValidate:function(){},onSaveSuccess:function(){},onSaveError:function(){},onLoadStart:function(){},onLoadSuccess:function(){},onLoadError:function(){}},formDangerClass:"uk-form-danger"},s=function(t,e){this.element=t,this.settings=_.extend({},a,e),this._defaults=a,this._name=i,this._prefix=this.element.id,this._formTypes=["text","email","password","tags","select","passwordConfirm","captcha","launcher","textarea","checkboxlist","valueslist","valueslistfixed","valueslisteditable"],this._saving=!1,this.init()};_.extend(s.prototype,{init:function(){var t="",e="";for(var i in this.settings.items){var a=this.settings.items[i],s="";switch((a.validation&&!this.settings.edit&&a.validation.mandatoryCreate||a.validation&&this.settings.edit&&a.validation.mandatoryEdit)&&(s=this.settings.html.bullet),a.type){case"text":case"email":case"password":case"tags":t+=this._template(this.settings.html.text,{prefix:this._prefix,name:i,label:a.label,bullet:s,css:a.css?" "+a.css:"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",type:a.type});break;case"launcher":t+=this._template(this.settings.html.launcher,{prefix:this._prefix,name:i,label:a.label,bullet:s,labelBtn:a.labelBtn,data:a.data,value:a.value,css:a.css?" "+a.css:"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",html:a.html?" "+a.html:""});break;case"valueslist":var n="";for(var l in a.values)n+=this._template(this.settings.html.valueslistItem,{prefix:this._prefix,name:i,key:a.values[l].p,value:a.values[l].v,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});t+=this._template(this.settings.html.valueslist,{prefix:this._prefix,name:i,label:a.label,bullet:s,items:n});break;case"valueslisteditable":var r="";for(var o in a.values)r+=this._template(a.values[o].t?this.settings.html.valueslistItemEditablePostfix:this.settings.html.valueslistItemEditable,{prefix:this._prefix,name:i,key:a.values[o].p,value:a.values[o].v,postfix:a.values[o].t,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});t+=this._template(this.settings.html.valueslistEditable,{prefix:this._prefix,name:i,label:a.label,bullet:s,items:r,helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",buttons:a.buttons||""});break;case"valueslistfixed":var d="";for(var u in a.values)d+=this._template(this.settings.html.valueslistItemFixed,{prefix:this._prefix,name:i,key:a.values[u].p,value:a.values[u].t,data:a.values[u].v,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});t+=this._template(this.settings.html.valueslistFixed,{prefix:this._prefix,name:i,label:a.label,bullet:s,items:d});break;case"select":var c="";for(var p in a.values)c+='<option value="'+p+'">'+a.values[p]+"</option>";t+=this._template(this.settings.html.select,{prefix:this._prefix,name:i,label:a.label,bullet:s,css:a.css?" "+a.css:"",multiple:a.multiple?" multiple":"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",type:a.type,values:c});break;case"checkboxlist":var m="";for(var f in a.values)m+=this._template(this.settings.html.checkboxlistItem,{prefix:this._prefix,name:i,title:a.values[f]});t+=this._template(this.settings.html.checkboxlist,{prefix:this._prefix,name:i,label:a.label,bullet:s,css:a.css?" "+a.css:"",multiple:a.multiple?" multiple":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",items:m});break;case"passwordConfirm":t+=this._template(this.settings.html.passwordConfirm,{prefix:this._prefix,name:i,label:a.label,bullet:s,css:a.css?" "+a.css:"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",type:"password"});break;case"captcha":t+=this._template(this.settings.html.captcha,{prefix:this._prefix,name:i,css:a.css?" "+a.css:"",label:a.label,bullet:s,helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):"",autofocus:a.autofocus?"autofocus":""});break;case"textarea":t+=this._template(this.settings.html.textarea,{prefix:this._prefix,name:i,label:a.label,bullet:s,css:a.css?" "+a.css:"",autofocus:a.autofocus?"autofocus":"",helpText:a.helpText?this._template(this.settings.html.helpText,{text:a.helpText,prefix:this._prefix}):""});break;case"buttons":for(var h="",v=0;v<a.buttons.length;v++){var g=a.buttons[v];h+=this._template(this.settings.html.button,{css:g.css?" "+g.css:"",prefix:this._prefix,name:g.name||"button"+v,type:g.type||"button",label:g.label||""})+"&nbsp;"}e+=this._template(this.settings.html.buttonsWrap,{prefix:this._prefix,css:a.css?" "+a.css:"",buttons:h,html:a.html?" "+a.html:""})}}_(this.element).html(this._template(this.settings.template.fields,{fields:t})+this._template(this.settings.template.buttons,{buttons:e})),_(".formBuilder-valueslist-btnAdd").unbind(),_(".formBuilder-valueslist-btnAdd").click(function(t){b._valueslistAddFunc(_(this).attr("data-prefix"),_(this).attr("data-name"),"","")}),_(".formBuilder-valueslist-btnDel").unbind(),_(".formBuilder-valueslist-btnDel").click(function(t){_(this).parent().parent().remove()}),_(".formBuilder-valueslistfixed-btnAdd").unbind(),_(".formBuilder-valueslistfixed-btnAdd").click(function(t){b._valueslistfixedAddFunc(_(this).attr("data-prefix"),_(this).attr("data-name"),"","")}),_(".formBuilder-valueslistfixed-btnDel").unbind(),_(".formBuilder-valueslistfixed-btnDel").click(function(t){_(this).parent().parent().remove()}),_(".formBuilder-valueslisteditable-btnAdd").unbind(),_(".formBuilder-valueslisteditable-btnAdd").click(function(t){b._valueslistAddFunc(_(this).attr("data-prefix"),_(this).attr("data-name"),"","")}),_(".formBuilder-valueslisteditable-btnDel").unbind(),_(".formBuilder-valueslisteditable-btnDel").click(function(t){_(this).parent().parent().remove()}),this.settings.events.onInit&&this.settings.events.onInit();var b=this;for(var x in _(this.element).submit(function(t){t.preventDefault(),b._submit()}),this._captchaInit(),this.settings.items){this.settings.items[x].autofocus&&_("#"+this._prefix+"_"+x).focus()}},_valueslistAddFunc:function(t,e,i,a,s){var n=this._template(this.settings.html.valueslistItem,{prefix:t,name:e,key:i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),value:a,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});_("#"+t+"_"+e+"_wrap").append(n),s||_("."+t+"-"+e+"-item").last().find("div>input:first").focus(),_(".formBuilder-valueslist-btnDel").unbind(),_(".formBuilder-valueslist-btnDel").click(function(t){t.stopPropagation(),_(this).parent().parent().remove()})},_valueslisteditableAddFunc:function(t,e,i,a,s,n,l){if(n="undefined"===n?null:n,i){i=String(i);var r=this._template(n?this.settings.html.valueslistItemEditablePostfix:this.settings.html.valueslistItemEditable,{prefix:t,name:e,key:i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),value:a,data:s,postfix:n,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});_("#"+t+"_"+e+"_wrap").append(r),l||_("."+t+"-"+e+"-item").last().find("div>input:first").focus(),_(".formBuilder-valueslisteditable-btnDel").unbind(),_(".formBuilder-valueslisteditable-btnDel").click(function(t){t.stopPropagation(),_(this).parent().parent().remove()})}},_valueslistfixedAddFunc:function(t,e,i,a,s){var n=this._template(this.settings.html.valueslistfixedItem,{prefix:t,name:e,key:i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),value:a,langParameter:this.settings.lang.parameter,langValue:this.settings.lang.value});_("#"+t+"_"+e+"_wrap").append(n),s||_("."+t+"-"+e+"-item").last().find("div>input:first").focus(),_(".formBuilder-valueslistfixed-btnDel").unbind(),_(".formBuilder-valueslistfixed-btnDel").click(function(t){t.stopPropagation(),_(this).parent().parent().remove()})},setValidation:function(t){this.validation=t},setEditMode:function(t){this.settings.edit=t},clearErrors:function(){_("."+this._prefix+"-form-field").removeClass(this.settings.formDangerClass),_("."+this._prefix+"-error-text").hide()},resetForm:function(){this.clearErrors();for(var t in _("."+this._prefix+"-form-field").not(".zoiaFormBuilder-no-reset").val(""),_("select."+this._prefix+"-form-field").prop("selectedIndex",0),_(".formBuilder-valueslist-val").val(""),_("."+this._prefix+"-formBuilder-valueslist-wrap").html(""),this.settings.items){var e=this.settings.items[t];e.default&&_("#"+this._prefix+"_"+t).val(e.default),"launcher"===e.type&&(_("#"+this._prefix+"_"+t+"_val").html(e.value),_("#"+this._prefix+"_"+t+"_val").attr("data",e.data)),"checkboxlist"===e.type&&_("."+this._prefix+"-"+t+"-cbx").prop("checked",!1)}},serialize:function(){var s=this,n={};for(var l in this.settings.items){var r=this.settings.items[l];-1!==this._formTypes.indexOf(r.type)&&function(){switch(r.type){case"launcher":n[l]={type:r.type,value:_("#"+s._prefix+"_"+l+"_val").html(),id:_("#"+s._prefix+"_"+l+"_val").attr("data")};break;case"checkboxlist":var t=_("."+s._prefix+"-"+l+"-cbx:checked").map(function(){return _(this).attr("data")}).get();n[l]={type:r.type,value:t.join(",")};break;case"valueslist":var e=[];_("."+s._prefix+"-"+l+"-item").each(function(){e.push({p:String(_(this).find("*>.formBuilder-valueslist-par").val()),v:String(_(this).find("*>.formBuilder-valueslist-val").val())})}),n[l]={type:r.type,value:e};break;case"valueslisteditable":var i=[];_("."+s._prefix+"-"+l+"-item").each(function(){i.push({p:String(_(this).find("*>.formBuilder-valueslist-par").html()),v:String(_(this).find("*>.formBuilder-valueslist-val").val()),d:String(_(this).find("*>.formBuilder-valueslist-val").attr("data")),t:String(_(this).find("*>.formBuilder-valueslist-val").attr("data-postfix"))})}),n[l]={type:r.type,value:i};break;case"valueslistfixed":var a=[];_("."+s._prefix+"-"+l+"-item").each(function(){a.push({p:String(_(this).find("*>.formBuilder-valueslist-val").attr("data")),v:String(_(this).find("*>.formBuilder-valueslist-val").val())})}),n[l]={type:r.type,value:a};break;default:n[l]={type:r.type,value:_("#"+s._prefix+"_"+l).val()}}}()}return n},deserialize:function(t){if(t&&"object"===(void 0===t?"undefined":_typeof(t)))for(var e in this.settings.items)switch(t[e]||(t[e]={id:"",value:""}),t[e].type){case"launcher":_("#"+this._prefix+"_"+e+"_val").html(t[e].value),_("#"+this._prefix+"_"+e+"_val").attr("data",t[e].id);break;case"checkboxlist":var i=t[e].value.split(",");for(var a in i)_('.editForm-groups-cbx[data="'+i[a]+'"]').prop("checked",!0);break;case"valueslist":var s=[];for(var n in t[e].value)s.push(t[e].value[n].p),s.push(t[e].value[n].v);for(_("#"+this._prefix+"_"+e+"_wrap").html("");0<s.length;){var l=s.shift(),r=s.shift();this._valueslistAddFunc(this._prefix,e,l,r,!0)}break;case"valueslisteditable":var o=[];for(var d in t[e].value)o.push(t[e].value[d].p),o.push(t[e].value[d].v),o.push(t[e].value[d].d),o.push(t[e].value[d].t);for(_("#"+this._prefix+"_"+e+"_wrap").html("");0<o.length;){var u=o.shift(),c=o.shift(),p=o.shift(),m=o.shift();this._valueslisteditableAddFunc(this._prefix,e,u,c,p,m,!0)}break;case"valueslistfixed":for(var f in _("."+this._prefix+"-"+e+"-item-val").val(""),t[e].value)_("."+this._prefix+"-"+e+'-item-val[data="'+t[e].value[f].p+'"]').val(t[e].value[f].v);break;default:_("#"+this._prefix+"_"+e).val(t[e].value||"")}},deserializePart:function(t,e){if(e&&"object"===(void 0===e?"undefined":_typeof(e)))switch(e||(e={id:"",value:""}),e.type){case"launcher":_("#"+this._prefix+"_"+t+"_val").html(e.value),_("#"+this._prefix+"_"+t+"_val").attr("data",e.id);break;case"checkboxlist":var i=e.value.split(",");for(var a in i)_('.editForm-groups-cbx[data="'+i[a]+'"]').prop("checked",!0);break;case"valueslist":var s=[];for(var n in e.value)s.push(e.value[n].p),s.push(e.value[n].v);for(_("#"+this._prefix+"_"+t+"_wrap").html("");0<s.length;){var l=s.shift(),r=s.shift();this._valueslistAddFunc(this._prefix,t,l,r,!0)}break;case"valueslisteditable":var o=[];for(var d in e.value)o.push(e.value[d].p),o.push(e.value[d].v),o.push(e.value[d].d),o.push(e.value[d].t);for(_("#"+this._prefix+"_"+t+"_wrap").html("");0<o.length;){var u=o.shift(),c=o.shift(),p=o.shift(),m=o.shift();this._valueslisteditableAddFunc(this._prefix,t,u,c,p,m,!0)}break;case"valueslistfixed":for(var f in _("."+this._prefix+"-"+t+"-item-val").val(""),e.value)_("."+this._prefix+"-"+t+'-item-val[data="'+e.value[f].p+'"]').val(e.value[f].v);break;default:_("#"+this._prefix+"_"+t).val(e.value||"")}},loadJSON:function(t){var c=this,p=this;jQuery.each(t,function(t,e){if(_("#"+p._prefix+"_"+t).val(e),p.settings.items[t]&&"checkboxlist"===p.settings.items[t].type&&e){var i=e.split(",");for(var a in i)_('.editForm-groups-cbx[data="'+i[a]+'"]').prop("checked",!0)}if(p.settings.items[t]&&"valueslist"===p.settings.items[t].type&&e){var s=[];for(var n in e)s.push(n),s.push(e[n]);for(var l in _("#"+p._prefix+"_"+t+"_wrap").html(""),e)p._valueslistAddFunc(p._prefix,t,s.shift(),s.shift())}if(p.settings.items[t]&&"valueslisteditable"===p.settings.items[t].type&&e){var r=[];for(var o in e)r.push(o),r.push(e[o]);for(var d in _("#"+p._prefix+"_"+t+"_wrap").html(""),e)p._valueslisteditableAddFunc(p._prefix,t,r.shift(),r.shift(),r.shift(),r.shift())}if(p.settings.items[t]&&"valueslistfixed"===p.settings.items[t].type&&e)for(var u in _("."+c._prefix+"-"+t+"-item-val").val(""),e)_("."+c._prefix+"-"+t+'-item-val[data="'+e[u].p+'"]').val(e[u].v)})},loadData:function(t){var c=this;this.settings.events.onLoadStart&&this.settings.events.onLoadStart(),this.resetForm();var p=this;_.ajax({type:this.settings.load.method,url:this.settings.load.url,data:t,cache:!1}).done(function(t){t&&1===t.status?(jQuery.each(t.item,function(t,e){if(_("#"+p._prefix+"_"+t).val(e),p.settings.items[t]&&"checkboxlist"===p.settings.items[t].type&&e){var i=e.split(",");for(var a in i)_('.editForm-groups-cbx[data="'+i[a]+'"]').prop("checked",!0)}if(p.settings.items[t]&&"valueslist"===p.settings.items[t].type&&e){var s=[];for(var n in e)s.push(n),s.push(e[n]);for(var l in _("#"+p._prefix+"_"+t+"_wrap").html(""),e)p._valueslistAddFunc(p._prefix,t,s.shift(),s.shift())}if(p.settings.items[t]&&"valueslisteditable"===p.settings.items[t].type&&e){var r=[];for(var o in e)r.push(o),r.push(e[o]);for(var d in _("#"+p._prefix+"_"+t+"_wrap").html(""),e)p._valueslisteditableAddFunc(p._prefix,t,r.shift(),r.shift(),r.shift())}if(p.settings.items[t]&&"valueslistfixed"===p.settings.items[t].type&&e)for(var u in _("."+c._prefix+"-"+t+"-item-val").val(""),e)_("."+c._prefix+"-"+t+'-item-val[data="'+e[u].p+'"]').val(e[u].v)}),p.settings.events.onLoadSuccess&&p.settings.events.onLoadSuccess(t)):p.settings.events.onLoadError&&p.settings.events.onLoadError(t)}).fail(function(t,e){p.settings.events.onLoadError&&p.settings.events.onLoadError(t,e)})},captchaRefresh:function(){_("."+this._prefix+"-captcha-img").show(),_("."+this._prefix+"-captcha-img").attr("src",this.settings.captcha+"?"+(new Date).getTime()),_("."+this._prefix+"-captcha-field").val("")},_captchaInit:function(){this.captchaRefresh();var t=this;_("img."+this._prefix+"-captcha-img").click(function(){t.captchaRefresh()})},_template:function(t,e){for(var i in e)t=t.replace(new RegExp("{"+i+"}","g"),e[i]);return t},validate:function(e){var i=this,t={},a={};for(var s in this.settings.items){var n=this.settings.items[s];if(-1!==this._formTypes.indexOf(n.type))if("launcher"!==n.type){if("valueslist"===n.type)if("continue"===function(){if(e&&e[s])return a[s]=e[s].value,"continue";var t=[];return _("."+i._prefix+"-"+s+"-item").each(function(){t.push({p:String(_(this).find("*>.formBuilder-valueslist-par").val()),v:String(_(this).find("*>.formBuilder-valueslist-val").val())})}),a[s]=t,"continue"}())continue;if("valueslisteditable"===n.type)if("continue"===function(){if(e&&e[s])return a[s]=e[s].value,"continue";var t=[];return _("."+i._prefix+"-"+s+"-item").each(function(){t.push({p:String(_(this).find("*>.formBuilder-valueslist-par").val()),v:String(_(this).find("*>.formBuilder-valueslist-val").val())})}),a[s]=t,"continue"}())continue;if("valueslistfixed"===n.type)if("continue"===function(){if(e&&e[s])return a[s]=e[s].value,"continue";var t=[];return _("."+i._prefix+"-"+s+"-item").each(function(){t.push({p:String(_(this).find("*>.formBuilder-valueslist-val").attr("data")),v:String(_(this).find("*>.formBuilder-valueslist-val").val())})}),a[s]=t,"continue"}())continue;if("checkboxlist"!==n.type){var l=e?e[s]?e[s].value:void 0:_("#"+this._prefix+"_"+s).val();if(n.validation){if(!n.validation.mandatoryEdit&&!l&&this.settings.edit||!n.validation.mandatoryCreate&&!l&&!this.settings.edit)continue;if(n.validation.mandatoryCreate&&!l&&!this.settings.edit){t[s]=this.settings.lang.mandatoryMissing;continue}if(n.validation.mandatoryEdit&&!l&&this.settings.edit){t[s]=this.settings.lang.mandatoryMissing;continue}if(n.validation.process&&"function"==typeof n.validation.process&&(l=n.validation.process(l)),"passwordConfirm"===n.type)if(_("#"+this._prefix+"_"+s+"Confirm").val()!==l){t[s]=this.settings.lang.passwordsNotMatch;continue}if(n.validation.length){if(n.validation.length.min&&l.length<n.validation.length.min){t[s]=this.settings.lang.tooShort;continue}if(n.validation.length.max&&l.length>n.validation.length.max){t[s]=this.settings.lang.tooLong;continue}}if(n.validation.regexp&&!l.match(n.validation.regexp)){t[s]=this.settings.lang.invalidFormat;continue}a[s]=l}}else{var r=_("."+this._prefix+"-"+s+"-cbx:checked").map(function(){return _(this).attr("data")}).get();a[s]=e?e[s]?e[s].value:void 0:r.join(",")}}else a[s]=e?e[s]?e[s].id:void 0:_("#"+this._prefix+"_"+s+"_val").attr("data")}return{data:a,errors:t}},errors:function(t){if(0<Object.keys(t).length){var e=!1;for(var i in t)_("#"+this._prefix+"_"+i).addClass(this.settings.formDangerClass),_("#"+this._prefix+"_"+i+"_error_text > span").html(t[i]),_("#"+this._prefix+"_"+i+"_error_text").show(),e||(_("#"+this._prefix+"_"+i).focus(),e=!0),"passwordConfirm"===this.settings.items[i].type&&_("#"+this._prefix+"_"+i+"Confirm").addClass(this.settings.formDangerClass);return!0}return!1},_submit:function(){if(!this._saving){this.settings.events.onSaveSubmit&&this.settings.events.onSaveSubmit(),this.clearErrors();var a=this,t={},e={};if(this.settings.validation){var i=this.validate();if(t=i.data||{},e=i.errors||{},this.errors(e))return;if(this.settings.events.onSaveValidate&&"__stop"===(t=this.settings.events.onSaveValidate(t,e)||t))return}else if(this.settings.events.onSaveValidate&&"__stop"===(t=this.settings.events.onSaveValidate(t)))return;a._saving=!0,_.ajax({type:this.settings.save.method,url:this.settings.save.url,data:t,cache:!1}).done(function(t){if(a._saving=!1,t&&1===t.status)a.settings.events.onSaveSuccess&&a.settings.events.onSaveSuccess(t);else{if(t.fields)for(var e in t.fields){var i=!1;_("#"+a._prefix+"_"+t.fields[e]).addClass(a.settings.formDangerClass),i||(_("#"+a._prefix+"_"+t.fields[e]).focus(),i=!0)}a.captchaRefresh(),a.settings.events.onSaveError&&a.settings.events.onSaveError(t)}}).fail(function(t,e){a._saving=!1,a.captchaRefresh(),a.settings.events.onSaveError&&a.settings.events.onSaveError(t,e)})}}}),_.fn[i]=function(t){var e=void 0;return this.each(function(){(e=_.data(this,"plugin_"+i))||(e=new s(this,t),_.data(this,"plugin_"+i,e))}),e}}(jQuery,window,document),function(d){var i="zoiaTable",a={limit:10,maxPages:7,html:{spinnerHTML:'<div style="width:40px;height:40px;background-color:#333;-webkit-animation:sk-rotateplane 1.2s infinite ease-in-out;animation: sk-rotateplane 1.2s infinite ease-in-out;margin: auto;position: absolute;top:0;left:0;bottom:0;right:0"></div>',spinnerWrapCSS:"background:#fff;position:absolute;opacity:0.6",headCSS:"@-webkit-keyframes sk-rotateplane{0%{-webkit-transform:perspective(120px)}50%{-webkit-transform:perspective(120px) rotateY(180deg)}100%{-webkit-transform:perspective(120px) rotateY(180deg) rotateX(180deg)}}@keyframes sk-rotateplane{0%{transform:perspective(120px) rotateX(0deg) rotateY(0deg);-webkit-transform:perspective(120px) rotateX(0deg) rotateY(0deg)}50%{transform:perspective(120px) rotateX(-180.1deg) rotateY(0deg);-webkit-transform:perspective(120px) rotateX(-180.1deg) rotateY(0deg)}100%{transform:perspective(120px) rotateX(-180deg) rotateY(-179.9deg);-webkit-transform:perspective(120px) rotateX(-180deg) rotateY(-179.9deg)}}",listWrapStartHTML:'<ul class="za-pagination" za-margin>',listWrapEndHTML:"</ul>",itemPagePrevHTML:'<li><a href="#"><a class="zoia-page {elementId}PaginationLink" data-page="{page}"><span za-pagination-previous></span></a></li>',itemPageNextHTML:'<li><a href="#"><a class="zoia-page {elementId}PaginationLink" data-page="{page}"><span za-pagination-next></span></a></li>',itemPageHTML:'<li><a class="zoia-page {elementId}PaginationLink" data-page="{page}">{page}</a></li>',itemPageDotsHTML:'<li class="za-disabled"><span>...</span></li>',arrowDown:"&nbsp;&#x25BC;",arrowUp:"&nbsp;&#x25B2;",errorHTML:'<tr><td colspan="100%">{error}</td></tr>'},lang:{error:"Could not load data from server. Please try to refresh page in a few moments.",noitems:"No items to display"},sort:{},loadOnStart:!0,onLoad:function(){}};function s(t,e){this.element=t,this.settings=d.extend({},a,e),this._defaults=a,this._name=i,this.page=1,this.loading=!1,this.search="",this.currentData={},this.init()}d.extend(s.prototype,{init:function(){var e=this;d("head").append('<style type="text/css">'+this.settings.html.headCSS+"</style>"),d(this.element).before('<div style="'+this.settings.html.spinnerWrapCSS+'" id="'+this.element.id+'LoadingDiv">'+this.settings.html.spinnerHTML+"</div>"),this._loading(!1),this.header=[];for(var t=0;t<d("#"+this.element.id+" > thead > tr").children("th").length;t++){var i=d("#"+this.element.id+" > thead > tr").children("th")[t];if(i.id){this.header.push(i.id);var a=i.id.replace(new RegExp("^"+this.element.id+"_"),"");this.settings.fields[a]&&this.settings.fields[a].sortable&&(d(i).css("cursor","pointer"),d(i).click(function(t){e._sortColumn(t)}))}}d("."+this.element.id+"SearchInput").keypress(e._debounce(function(t){e._search(t)},250)),d("."+this.element.id+"SearchInputClear").click(function(t){e._searchReset(t)}),this.settings.loadOnStart&&this.load()},_search:function(t){this.loading||(this.search=d(t.target).val().trim(),this.page=1,this.load())},_searchReset:function(){this.loading||(d("."+this.element.id+"SearchInput").val("").focus(),this.search="",this.page=1,this.load())},_sortIndicator:function(t,e){d("#"+this.element.id+"SortingIndicator").remove();for(var i="desc"===e?this.settings.html.arrowDown:this.settings.html.arrowUp,a=0;a<d("#"+this.element.id+" > thead > tr").children("th").length;a++){var s=d("#"+this.element.id+" > thead > tr").children("th")[a];s.id===this.element.id+"_"+t&&d(s).html(d(s).html()+'<span class="zoiaTableSortingIndicator" id="'+this.element.id+'SortingIndicator">'+i+"</span>")}},_sortColumn:function(t){if(t.preventDefault(),t.target.id&&t.target.id!==this.element.id+"SortingIndicator"){var e=t.target.id.replace(new RegExp("^"+this.element.id+"_"),"");this.settings.sort.field===e?this.settings.sort.direction="asc"===this.settings.sort.direction?"desc":"asc":(this.settings.sort.field=e,this.settings.sort.direction="asc"),this.load()}},_template:function(t,e){for(var i in e)t=t.replace(new RegExp("{"+i+"}","g"),e[i]);return t},_bindSelectButtons:function(){var t=this;d("."+this.element.id+"BtnSelectAll").click(function(){t._selectAll()}),d("."+this.element.id+"BtnSelectNone").click(function(){t._selectNone()})},_selectAll:function(){this.loading||d("."+this.element.id+"Checkbox").prop("checked",!0)},_selectNone:function(){this.loading||d("."+this.element.id+"Checkbox").prop("checked",!1)},_pagination:function(){var e=this,t=this.settings.maxPages,i=Math.ceil(this.total/this.settings.limit);if(i<2)d("."+this.element.id+"Pagination").html("");else{var a=this.settings.html.listWrapStartHTML;if(t<i){1<this.page&&(a+=this._template(this.settings.html.itemPagePrevHTML,{elementId:this.element.id,page:this.page-1})),3<this.page&&(a+=this._template(this.settings.html.itemPageHTML,{elementId:this.element.id,page:1}));var s=this.page-2;s<1&&(s=1),1<s-1&&(a+=this.settings.html.itemPageDotsHTML);var n=this.page+2;i<n&&(n=i);for(var l=s;l<=n;l++)a+=this._template(this.settings.html.itemPageHTML,{elementId:this.element.id,page:l});n<i-1&&(a+=this.settings.html.itemPageDotsHTML),this.page<=i-3&&(a+=this._template(this.settings.html.itemPageHTML,{elementId:this.element.id,page:i})),this.page<i&&(a+=this._template(this.settings.html.itemPageNextHTML,{elementId:this.element.id,page:this.page+1}))}else for(var r=1;r<=i;r++)a+=this._template(this.settings.html.itemPageHTML,{elementId:this.element.id,page:r});a+=this.settings.html.listWrapEndHTML,d("."+this.element.id+"Pagination").html(a),d("."+this.element.id+"PaginationLink").click(function(){var t=parseInt(d(this).data("page"),10);e.loading||e.page===t||(e.page=t,e.load())})}},_loading:function(t){var e="#"+this.element.id+"LoadingDiv";d(e).css({top:d(this.element).top,left:d(this.element).left,width:d(this.element).outerWidth(!0),height:d(this.element).outerHeight(!0)}),t?this.loadingInt=setTimeout(function(){d(e).show()},300):(clearTimeout(this.loadingInt),d(e).hide())},_debounce:function(i,a){var s=null;return function(){var t=this,e=arguments;clearTimeout(s),s=setTimeout(function(){i.apply(t,e)},a)}},getCurrentData:function(){return this.currentData},load:function(){if(this.settings.url&&!this.loading){var r=this,o="";this._loading(!0),this.loading=!0,d.ajax({type:"GET",url:this.settings.url,data:{limit:this.settings.limit,skip:this.page*this.settings.limit-this.settings.limit,sortField:this.settings.sort.field,sortDirection:this.settings.sort.direction,search:this.search},cache:!1}).done(function(t){if(r.loading=!1,t){for(var e in r.pages=parseInt(t.total/r.settings.limit,10),0<t.total%r.settings.limit&&r.pages++,r.total=t.total,r._pagination(),r.currentData={},t.items){var i=t.items[e];for(var a in r.currentData[i._id]=i,o+="<tr>",r.header)if(r.header[a]===r.element.id+"ID")o+='<td><input type="checkbox" id="'+i._id+'" class="za-checkbox '+r.element.id+'Checkbox"></td>';else{var s=!1,n=r.header[a].replace(new RegExp("^"+r.element.id+"_"),"");for(var l in i)l===n&&r.settings.fields[l]&&(i[l]&&"string"==typeof i[l]&&(i[l]=i[l].replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")),o+="<td>"+r.settings.fields[l].process(l,i,i[l])+"</td>",s=!0);s||(r.settings.fields[n]&&r.settings.fields[n].process?o+="<td>"+r.settings.fields[n].process(n,i)+"</td>":o+="<td></td>")}o+="</tr>"}d(r.element).find("tbody").html(o.length?o:r._template(r.settings.html.errorHTML,{error:r.settings.lang.noitems})),r._loading(!1),d('*[data-page="'+r.page+'"]').parent().addClass("za-active"),r._bindSelectButtons(),r.settings.sort.field&&r._sortIndicator(r.settings.sort.field,r.settings.sort.direction),d(r.element).find("thead").show(),r.settings.onLoad()}else r.loading=!1,r._loading(!1),d(r.element).find("tbody").html(r._template(r.settings.html.errorHTML,{error:r.settings.lang.error}))}).fail(function(){r.loading=!1,r._loading(!1),d(r.element).find("tbody").html(r._template(r.settings.html.errorHTML,{error:r.settings.lang.error}))})}}}),d.fn[i]=function(t){var e=void 0;return this.each(function(){(e=d.data(this,"plugin_"+i))||(e=new s(this,t),d.data(this,"plugin_"+i,e))}),e}}(jQuery,window,document);var BACKSPACE=8,TAB=9,ENTER=13,LEFT=37,RIGHT=39,DELETE=46,COMMA=188,SEPERATOR=",",COPY_PROPS="placeholder pattern spellcheck autocomplete autocapitalize autofocus accessKey accept lang minLength maxLength required".split(" ");function tagsInput(a){function s(t,e,i,a){var s=document.createElement(t);for(var n in e&&(s.className=e),i&&(s.textContent=i),a)s.setAttribute("data-"+n,a[n]);return s}function l(t,e){return!0===e?Array.prototype.slice.call(p.querySelectorAll(t)):p.querySelector(t)}function t(){return l(".tag",!0).map(function(t){return t.textContent}).concat(p.input.value||[]).join(SEPERATOR)}function e(t){l(".tag",!0).forEach(function(t){return p.removeChild(t)}),u(t)}function e(t){l(".tag",!0).forEach(function(t){return p.removeChild(t)}),u(t)}function r(){a.value=t(),a.dispatchEvent(new Event("change"))}function n(t){if(~t.indexOf(SEPERATOR)&&(t=t.split(SEPERATOR)),Array.isArray(t))return t.forEach(n);var e=t&&t.trim();if(!e)return!1;if(!a.getAttribute("duplicates")){var i=l('[data-tag="'+e+'"]');if(i)return i.classList.add("dupe"),setTimeout(function(){return i.classList.remove("dupe")},100),!1}p.insertBefore(s("span","tag",e,{tag:e}),p.input)}function o(t){var e=l(".selected");e&&e.classList.remove("selected"),t&&t.classList.add("selected")}function d(){var t=l(".tag",!0).pop(),e=p.offsetWidth;e&&(p.input.style.width=Math.max(e-(t?t.offsetLeft+t.offsetWidth:5)-5,e/4)+"px")}function u(t){"string"==typeof t||Array.isArray(t)||(t=p.input.value),!1!==n(t)&&(p.input.value="",r(),d())}function i(t){return t.target.classList.contains("tag")&&o(t.target),t.target===p.input?o():(p.input.focus(),t.preventDefault(),!1)}function c(e){try{return 0===e.selectionStart&&0===e.selectionEnd}catch(t){return""===e.value}}var p=s("div","tags-input"),m=a.nextSibling;a.parentNode[m?"insertBefore":"appendChild"](p,m),a.style.cssText="position:absolute;left:0;top:-99px;width:1px;height:1px;opacity:0.01;",a.tabIndex=-1;var f=a.getAttribute("type");return f&&"tags"!==f||(f="text"),p.input=s("input"),p.input.setAttribute("type",f),COPY_PROPS.forEach(function(t){if(a[t]!==p.input[t]){p.input[t]=a[t];try{delete a[t]}catch(t){}}}),p.appendChild(p.input),a.addEventListener("focus",function(){p.input.focus()}),p.input.addEventListener("focus",function(){p.classList.add("focus"),o()}),p.input.addEventListener("blur",function(){p.classList.remove("focus"),o(),u()}),p.input.addEventListener("keydown",function(t){var e=p.input,i=t.keyCode||t.which,a=l(".tag.selected"),s=c(e),n=l(".tag",!0).pop();if(d(),i===ENTER||i===TAB){if(!e.value)return;u()}else if(i===DELETE&&a)a.nextSibling!==p.input&&o(a.nextSibling),p.removeChild(a),d(),r();else if(i===BACKSPACE)if(a)o(a.previousSibling),p.removeChild(a),d(),r();else{if(!n||!s)return;o(n)}else if(i===LEFT)if(a)a.previousSibling&&o(a.previousSibling);else{if(!s)return;o(n)}else{if(i!==RIGHT)return o();if(!a)return;o(a.nextSibling)}return t.preventDefault(),!1}),p.input.addEventListener("keypress",function(t){var e=p.input,i=t.charCode;l(".tag.selected"),c(e),l(".tag",!0).pop();if(44===i){if(!e.value)return;u(),t.preventDefault()}return!1}),p.input.addEventListener("input",function(){a.value=t(),a.dispatchEvent(new Event("input"))}),p.input.addEventListener("paste",function(){return setTimeout(u,0)}),p.addEventListener("mousedown",i),p.addEventListener("touchstart",i),p.setValue=e,p.getValue=t,u(a.value),p}tagsInput.enhance=tagsInput.tagsInput=tagsInput;_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};!function(){var l=void 0,d=void 0,r=void 0,u={},c=void 0,n=void 0,a=void 0,p=void 0,s=void 0,e=void 0,o=void 0,m=void 0,f=void 0,i=function(t){var e=decodeURIComponent(window.location.search.substring(1)).split("&"),i=void 0,a=void 0;for(a=0;a<e.length;a++)if((i=e[a].split("="))[0]===t)return void 0===i[1]||i[1]},h=function(t){t?($(".editForm-form-button").hide(),$("#zoiaEditSpinner").show()):($(".editForm-form-button").show(),$("#zoiaEditSpinner").hide())},v=function(t){t?($(".zoia-delete-dialog-button").hide(),$("#zoiaDeleteDialogSpinner").show()):($(".zoia-delete-dialog-button").show(),$("#zoiaDeleteDialogSpinner").hide())},g=function(){for(var t in $("#wrapTable").hide(),$("#zoiaEdit").show(),$("#zoiaEditHeader").html(lang.addItem),s)u[t]={enabled:!0,data:{}};$("#editForm").zoiaFormBuilder().resetForm(),d=null,c=Object.keys(s)[0],z(c),$("#editForm_content").val(""),n.setValue(""),p&&!m&&(m=CodeMirror.fromTextArea(document.getElementById("editForm_content"),{mode:"htmlmixed",lineWrapping:!0,lineNumbers:!0}),window.zoiaCodeMirror=m),p&&(m.setValue(""),m.setSize($("#zoia_edit_form_footer").outerWidth()-3,300)),$("#editForm_timestamp").val(moment().locale(a).format(lang.dateTimeTemplate))},b=function(){$("#wrapTable").show(),$("#zoiaEdit").hide()},x=function(t){if(!t||"string"!=typeof t||!t.match(/^[0-9]{1,10}$/))return b();for(var e in d=t,s)u[e]={enabled:!0,data:{}};$("#wrapTable").hide(),$("#editForm").zoiaFormBuilder().resetForm(),$("#zoiaEditHeader").html(lang.editItem),c=Object.keys(s)[0],z(c),$("#zoiaSpinnerMain").show(),$("#editForm").zoiaFormBuilder().loadData({id:t})},_=function(t){if(!t)return b();var e=[],i=[];if(r=[],"object"===(void 0===t?"undefined":_typeof(t)))for(var a in r=e=t)i.push($("#blog").zoiaTable().getCurrentData()[t[a]].title);else e.push(t),r.push(t),i.push($("#blog").zoiaTable().getCurrentData()[t].title);for(var s in $("#zoiaDeleteDialogList").html(""),i)$("#zoiaDeleteDialogList").append("<li>"+i[s]+"</li>");v(!1),l.show()},y=function(t){if(!t)return b();var e=[],i=[];if(r=[],"object"===(void 0===t?"undefined":_typeof(t)))for(var a in r=e=t)i.push($("#comments").zoiaTable().getCurrentData()[t[a]].comment);else e.push(t),r.push(t),i.push($("#comments").zoiaTable().getCurrentData()[t].comment);var s='<ul class="za-list za-list-divider">';for(var n in i)s+="<li>"+i[n]+"</li>";s+="</ul>",$zUI.modal.confirm(lang["The following comment(s) will be deleted. Continue?"]+"<br><br>"+s,{labels:{ok:lang.Yes,cancel:lang.Cancel},stack:!0}).then(function(){$("#zoiaSpinnerMain").show(),$.ajax({type:"POST",url:"/api/blog/comments/remove",data:{commentId:r},cache:!1}).done(function(t){setTimeout(function(){$("#zoiaSpinnerMain").hide()},700),$("#comments").zoiaTable().load(),t&&1===t.status?(l.hide(),$zUI.notification(lang["Operation was successful"],{status:"success",timeout:1500})):$zUI.notification(lang["Cannot delete one or more items"],{status:"danger",timeout:1500})}).fail(function(){setTimeout(function(){$("#zoiaSpinnerMain").hide()},700),$("#comments").zoiaTable().load(),$zUI.notification(lang["Cannot delete one or more items"],{status:"danger",timeout:1500})})},function(){})},k=function(t){var e=t||{action:i("action"),id:i("id")};switch(e.action){case"edit":x(e.id);break;case"create":g();break;default:b()}},z=function(t){$("#zoiaEditLanguages > li").removeClass("za-active"),$("#zoiaEditLanguages > li[data="+t+"]").addClass("za-active")},w=function(t){if(!u[t].enabled)return u[c].data=$("#editForm").zoiaFormBuilder().serialize(),c=t,$("#zoiaEditLanguageCheckbox").prop("checked",!1),void $("#editForm").hide();if($("#zoiaEditLanguageCheckbox").prop("checked",!0),t===c)return $("#editForm").zoiaFormBuilder().deserialize(u[c].data);if(u[c].data=$("#editForm").zoiaFormBuilder().serialize(),u[c].enabled&&u[c].data&&u[c].data.status){var e=u[c].data.status,i=u[c].data.template,a=u[c].data.timestamp,s=u[c].data.comments;u[t].data.template=i,u[t].data.status=e,u[t].data.timestamp=a,u[t].data.comments=s,p&&(u[c].data.content.value=m.getValue())}z(c=t),$("#editForm").zoiaFormBuilder().resetForm(),$("#editForm").zoiaFormBuilder().deserialize(u[c].data),n.setValue(u[c].data.keywords.value),$("#editForm").show(),p&&(m.setValue(u[c].data.content.value),m.setSize($("#zoia_edit_form_footer").outerWidth()-3,300))};$(document).ready(function(){a=$("#zp_locale").attr("data"),p="true"===$("#zp_codemirror").attr("data"),o=$("#zp_uprefix").attr("data"),s=JSON.parse($("#zp_langs").attr("data")),e=JSON.parse($("#zp_templates").attr("data")),f=JSON.parse($("#zp_corePrefix").attr("data")),$.getScript("/api/lang/blog/"+a+".js").done(function(){for(var t in l=$zUI.modal("#zoiaDeleteDialog",{bgClose:!1,escClose:!1}),$(".zoiaDeleteButton").click(function(){var t=$(".blogCheckbox:checkbox:checked").map(function(){return this.id}).get();t&&0<t.length&&_(t)}),$(".zoiaDeleteCommentsButton").click(function(){var t=$(".commentsCheckbox:checkbox:checked").map(function(){return this.id}).get();t&&0<t.length&&y(t)}),$("#zoiaDeleteDialogButton").click(function(){v(!0),$.ajax({type:"POST",url:"/api/blog/delete",data:{id:r},cache:!1}).done(function(t){$("#blog").zoiaTable().load(),t&&1===t.status?(l.hide(),$zUI.notification(lang["Operation was successful"],{status:"success",timeout:1500})):($zUI.notification(lang["Cannot delete one or more items"],{status:"danger",timeout:1500}),v(!1))}).fail(function(){$("#blog").zoiaTable().load(),$zUI.notification(lang["Cannot delete one or more items"],{status:"danger",timeout:1500}),v(!1)})}),$("#editForm").zoiaFormBuilder({save:{url:"/api/blog/save",method:"POST"},load:{url:"/api/blog/load",method:"GET"},formDangerClass:"za-form-danger",template:{fields:"{fields}",buttons:"{buttons}"},html:{helpText:'<div class="za-text-meta">{text}</div>',text:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><div class="za-form-controls"><input class="za-input {prefix}-form-field{css}" id="{prefix}_{name}" type="{type}" placeholder=""{autofocus}><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div></div>',select:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><select class="za-select {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}>{values}</select><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div>',passwordConfirm:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><div class="za-flex"><div class="{prefix}-field-wrap"><input class="za-input {prefix}-form-field" id="{prefix}_{name}" type="password" placeholder=""{autofocus}></div><div><input class="za-input {prefix}-form-field" id="{prefix}_{name}Confirm" type="password" placeholder=""></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div>',captcha:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><div class="za-grid za-grid-small"><div><input class="za-input {prefix}-form-field {prefix}-captcha-field{css}" type="text" placeholder="" id="{prefix}_{name}"{autofocus}></div><div><div class="za-form-controls"><img class="{prefix}-captcha-img"></div></div></div><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}',buttonsWrap:'<div class="{css}">{buttons}{html}</div>',button:'<button class="za-button {prefix}-form-button{css}" id="{prefix}_{name}" type="{type}">{label}</button>',launcher:'<div class="za-margin"><label class="za-form-label" for="{prefix}_{name}_btn">{label}:</label><div class="za-flex"><div id="{prefix}_{name}_val" class="{prefix}-{name}-selector" data="{data}">{value}</div><div><button class="za-button za-button-default" id="{prefix}_{name}_btn" type="button">{labelBtn}</button></div></div>{helpText}</div>',textarea:'<div class="za-margin-bottom"><label class="za-form-label" for="{prefix}_{name}">{label}:</label><br><div class="za-form-controls"><textarea class="za-textarea {prefix}-form-field{css}" id="{prefix}_{name}"{autofocus}></textarea><div id="{prefix}_{name}_error_text" class="{prefix}-error-text" style="display:none"><span class="za-label-danger"></span></div>{helpText}</div></div>'},events:{onSaveValidate:function(t){u[c].data=$("#editForm").zoiaFormBuilder().serialize(),p&&(u[c].data.content.value=m.getValue());var e=u[c].data.template.value,i=u[c].data.status.value,a=u[c].data.comments.value,s=moment(u[c].data.timestamp.value,lang.dateTimeTemplate);if(!s.isValid())return $("#editForm_timestamp").addClass("za-form-danger"),$("#editForm_timestamp_error_text>span").html(lang["Doesn't match required format"]),$("#editForm_timestamp_error_text").show(),"__stop";var n=parseInt(s.valueOf()/1e3,10);for(var l in u)if(u[l].enabled){var r=u[l].data,o=$("#editForm").zoiaFormBuilder().validate(r);if(0<Object.keys(o.errors).length&&(z(l),w(l),o=$("#editForm").zoiaFormBuilder().validate($("#editForm").zoiaFormBuilder().serialize()),$("#editForm").zoiaFormBuilder().errors(o.errors)))return"__stop";o.data.template=e,o.data.timestamp=n,o.data.status=i,o.data.comments=a,t[l]=o.data}return t.id=d,h(!0),t},onSaveSuccess:function(){h(!1),$zUI.notification(lang.fieldErrors["Saved successfully"],{status:"success",timeout:1500}),$("#blog").zoiaTable().load(),$("#zoiaEdit").hide(),$("#wrapTable").show(),window.history.pushState({action:""},document.title,o+f.admin+"/blog")},onSaveError:function(t){if(h(!1),t&&void 0!==t.status)switch(t.status){case-1:$zUI.notification(lang.fieldErrors["Page not found"],{status:"danger",timeout:1500});break;case-2:$zUI.notification(lang.fieldErrors["Page already exists in database"],{status:"danger",timeout:1500});break;default:$zUI.notification(lang.fieldErrors["Could not save to the database"],{status:"danger",timeout:1500})}},onLoadSuccess:function(t){for(var e in s)Object.keys(t.item[e]).length<3?u[e]={enabled:!1}:(u[e]={enabled:!0,data:{}},u[e].data.title={type:"text",value:t.item[e].title},u[e].data.status={type:"select",value:t.item.status},u[e].data.template={type:"select",value:t.item.template},u[e].data.comments={type:"select",value:t.item.comments},u[e].data.timestamp={type:"text",value:moment(1e3*t.item.timestamp).locale(a).format(lang.dateTimeTemplate)},u[e].data.keywords={type:"text",value:t.item[e].keywords},u[e].data.content={type:"textarea",value:t.item[e].content});for(var i in $("#zoiaEditLanguageCheckbox").prop("checked",u[c].enabled),$("#zoiaEdit").show(),$("#zoiaSpinnerMain").hide(),p&&!m&&(m=CodeMirror.fromTextArea(document.getElementById("editForm_content"),{mode:"htmlmixed",lineWrapping:!0,lineNumbers:!0}),(window.zoiaCodeMirror=m).setSize($("#zoia_edit_form_footer").outerWidth()-3,300)),s)if(u[i].enabled){$("#zoiaEditLanguages > li[data="+i+"]").click(),n.setValue(u[c].data.keywords.value),p&&m.setValue(u[c].data.content.value);break}},onLoadError:function(){$("#zoiaSpinnerMain").hide(),$zUI.notification(lang["Could not load information from database"],{status:"danger",timeout:1500})}},validation:!1,items:{title:{type:"text",label:lang.Title,autofocus:!0,css:"za-width-large@m",validation:{mandatoryCreate:!0,mandatoryEdit:!0,length:{min:1,max:128},process:function(t){return t.trim()}},helpText:lang["Required, max. 128 characters"]},timestamp:{type:"text",label:lang["Date and Time"],css:"za-width-medium@m",validation:{mandatoryCreate:!0,mandatoryEdit:!0,length:{min:1,max:128},process:function(t){return t.trim()}},helpText:lang["Required, format"]+": "+lang.dateTimeFormat},status:{type:"select",label:lang.Status,css:"za-form-width-small",values:{0:lang.statuses[0],1:lang.statuses[1]},default:"1",validation:{mandatoryCreate:!0,mandatoryEdit:!0,length:{min:1,max:1},regexp:/^(0|1|2)$/}},template:{type:"select",label:lang.Template,css:"za-form-width-small",values:e,default:e[0]},comments:{type:"select",label:lang.Comments,css:"za-form-width-small",values:{0:lang.Disabled,1:lang.Enabled},default:1,validation:{mandatoryCreate:!0,mandatoryEdit:!0,length:{min:1,max:1},regexp:/^(0|1)$/}},keywords:{type:"tags",label:lang.Keywords,css:"za-width-1-1",validation:{mandatoryCreate:!1,mandatoryEdit:!1,length:{min:1,max:128},process:function(t){return t.trim()}},helpText:lang["Optional, max. 128 characters"]},content:{type:"textarea",label:lang.Content,validation:{mandatoryCreate:!1,mandatoryEdit:!1},css:"zoiaFormBuilder-no-reset"},buttons:{type:"buttons",css:"za-edit-buttons-wrap",buttons:[{label:lang.Cancel,css:"za-button-default",name:"btnCancel"},{name:"btnSave",label:lang.Save,css:"za-button-primary",type:"submit"}],html:'<div za-spinner style="display:none" id="zoiaEditSpinner"></div>'}},lang:{mandatoryMissing:lang["Should not be empty"],tooShort:lang["Too short"],tooLong:lang["Too long"],invalidFormat:lang["Doesn't match required format"],passwordsNotMatch:lang["Passwords do not match"]}}),s)$("#zoiaEditLanguages").append('<li data="'+t+'"><a href="#">'+s[t]+"</a></li>"),u[t]={enabled:!0,data:{}},c||(c=t);$("#blog").zoiaTable({url:"/api/blog/list",limit:20,sort:{field:"timestamp",direction:"desc"},fields:{_id:{sortable:!0,process:function(t,e,i){return i||"&ndash;"}},timestamp:{sortable:!0,process:function(t,e,i){return i?new Date(1e3*i).toLocaleString().replace(/\s/gm,"&nbsp;"):"&ndash;"}},title:{sortable:!0,process:function(t,e,i){return i||"&ndash;"}},status:{sortable:!0,process:function(t,e,i){return lang.statuses[i]||"&ndash;"}},actions:{sortable:!1,process:function(t,e){return'<button class="za-icon-button zoia-blog-action-edit-btn" za-icon="icon: pencil" data="'+e._id+'" style="margin-right:5px"></button><button class="za-icon-button zoia-blog-action-del-btn" za-icon="icon: trash" data="'+e._id+'"></button><div style="margin-bottom:17px" class="za-hidden@m">&nbsp;</div>'}}},onLoad:function(){$(".zoia-blog-action-edit-btn").click(function(){window.history.pushState({action:"edit",id:$(this).attr("data")},document.title,o+f.admin+"/blog?action=edit&id="+$(this).attr("data")),x($(this).attr("data"))}),$(".zoia-blog-action-del-btn").click(function(){_($(this).attr("data"))})},lang:{error:lang["Could not load data from server. Please try to refresh page in a few moments."],noitems:lang["No items to display"]}}),$("#comments").zoiaTable({url:"/api/blog/list/comments",limit:20,fields:{_id:{sortable:!1,process:function(t,e,i){return i||"&ndash;"}},comment:{sortable:!1,process:function(t,e){var i=new Date(1e3*e.timestamp).toLocaleString().replace(/\s/gm,"&nbsp;");return'<article class="za-comment"><header class="za-text-meta">'+e.username+" &raquo; "+e.title+"&nbsp;&nbsp;("+i+')</header><div class="za-comment-body">'+e.comment+"</div></article>"}},actions:{sortable:!1,process:function(t,e){return'<button class="za-icon-button zoia-comments-action-del-btn" za-icon="icon: trash" data="'+e._id+'"></button><div style="margin-bottom:17px" class="za-hidden@m">&nbsp;</div>'}}},onLoad:function(){$(".zoia-comments-action-del-btn").click(function(){y($(this).attr("data"))})},lang:{error:lang["Could not load data from server. Please try to refresh page in a few moments."],noitems:lang["No items to display"]}}),p&&($("#editForm_content").parent().prepend('<div class="za-width-1-1" style="height:40px"><span href="" class="za-icon-button" za-icon="image" style="margin-right:3px" id="zoia_codemirror_image" za-tooltip="'+lang["Insert Image"]+'"></span><span href="" class="za-icon-button" za-icon="more" id="zoia_codemirror_cut" za-tooltip="'+lang["Insert Blog Cut"]+'"></span></div>'),$("#zoia_codemirror_cut").click(function(){var t=m.getDoc(),e=t.getCursor(),i={line:e.line,ch:e.ch};t.replaceRange("{{cut}}",i),m.focus()}),$("#zoia_codemirror_image").click(function(){var t=window.screenLeft?window.screenLeft:window.screenX,e=window.screenTop?window.screenTop:window.screenY,i=t+window.innerWidth/2-400,a=e+window.innerHeight/2-250;window.open(o+f.admin+"/pages/browse","targetWindow","toolbar=no, location = no, status = no, menubar = no, scrollbars = yes, resizable = yes, width = 800, height = 500, top = "+a+", left = "+i)})),n=tagsInput(document.querySelector("#editForm_keywords")),$(".zoiaAdd").click(function(){window.history.pushState({action:"create"},document.title,o+f.admin+"/blog?action=create"),g()}),$("#editForm_btnCancel").click(function(){window.history.pushState({action:""},document.title,o+f.admin+"/blog"),$("#zoiaEdit").hide(),$("#wrapTable").show()}),$("#zoiaEditLanguages > li").click(function(){w($(this).attr("data"))}),$("#zoiaEditLanguageCheckbox").click(function(){!function(){if($("#zoiaEditLanguageCheckbox").prop("checked")){for(var t in $("#editForm").zoiaFormBuilder().resetForm(),n.setValue(""),u[c].enabled=!0,u[c].data={},s)u[t].data&&(u[t].data.template&&$("#editForm_template").val(u[t].data.template.value),u[t].data.status&&$("#editForm_status").val(u[t].data.status.value),u[t].data.timestamp&&$("#editForm_timestamp").val(u[t].data.timestamp.value),u[t].data.comments&&$("#editForm_comments").val(u[t].data.comments.value));$("#editForm_content").val(""),$("#editForm").show(),p&&(m.setValue(""),m.clearHistory())}else u[c].enabled=!1,p&&m.setValue(""),$("#editForm").hide()}()}),$(".blogBtnRefresh").click(function(){$("#blog").zoiaTable().load()}),$(".commentsBtnRefresh").click(function(){$("#comments").zoiaTable().load()}),window.setTimeout(function(){p?($(window).bind("popstate",function(t){k(t.originalEvent.state)}),$(window).resize(function(){m&&m.setSize($("#zoia_edit_form_footer").outerWidth()-3,300)}),k()):$("#editForm_content").ckeditor({filebrowserImageBrowseUrl:o+f.admin+"/pages/browse",filebrowserBrowseUrl:o+f.admin+"/pages/browse",filebrowserWindowWidth:800,filebrowserWindowHeight:500,allowedContent:!0}).editor.on("instanceReady",function(){$(window).bind("popstate",function(t){k(t.originalEvent.state)}),k()})},0),$(".zoia-admin-loading").hide(),$("#zoia_admin_panel_wrap").show()})})}();