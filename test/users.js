...
(async function example() {
    ...
    try {
        ...
        await driver.findElement(By.className('zoiaAdd')).click();
        ...
        await driver.findElement(By.id('editForm_btnSave')).click();
        ...
        await driver.findElement(By.xpath('//*[@id="users"]/tbody/tr[2]/td[6]/button[1]')).sendKeys(Key.SPACE);
        await driver.wait(until.elementLocated(By.id('editForm_username')), 5000);
