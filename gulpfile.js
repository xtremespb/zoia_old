...
gulp.task('cleanup', async() => {
    ...
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'warehouse.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'browse.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'catalog.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'catalog_cart.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'catalog_item.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'catalog_order.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'css', 'catalog_orders.min.css'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'warehouse.min.js'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'browse.min.js'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'catalog.min.js'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'catalog_cart.min.js'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'catalog_item.min.js'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'catalog_order.min.js'));
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'catalog_orders.min.js'));
});
...
gulp.task('warehouse', async() => {
    // Generate CSS
    gulp.src(['static/zoia/3rdparty/jstree/themes/default/style.min.css', 'modules/warehouse/static/css/warehouse.css'], { base: __dirname })
        .pipe(minifyCSS())
        .pipe(concat('warehouse.min.css'))
        .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'css')));
    gulp.src(['static/zoia/3rdparty/uikit/css/uikit.min.css', 'modules/warehouse/static/css/browse.css'], { base: __dirname })
        .pipe(minifyCSS())
        .pipe(concat('browse.min.css'))
        .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'css')));
    gulp.src(['modules/warehouse/static/css/catalog.css'], { base: __dirname })
        .pipe(minifyCSS())
        .pipe(concat('catalog.min.css'))
        .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'css')));
    gulp.src(['modules/warehouse/static/css/catalog_cart.css'], { base: __dirname })
        .pipe(minifyCSS())
        .pipe(concat('catalog_cart.min.css'))
        .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'css')));
    gulp.src(['modules/warehouse/static/css/catalog_item.css'], { base: __dirname })
        .pipe(minifyCSS())
        .pipe(concat('catalog_item.min.css'))
        .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'css')));
    gulp.src(['modules/warehouse/static/css/catalog_order.css'], { base: __dirname })
        .pipe(minifyCSS())
        .pipe(concat('catalog_order.min.css'))
        .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'css')));
    gulp.src(['modules/warehouse/static/css/catalog_orders.css'], { base: __dirname })
        .pipe(minifyCSS())
    ...
    await new Promise((resolve) => {
        gulp.src(['modules/warehouse/static/js/browse.js'], { base: __dirname })
            .pipe(babel({
                presets: ['env']
            }))
            .pipe(concat('browse'))
    ...
    await new Promise((resolve) => {
        gulp.src(['static/zoia/3rdparty/uikit/js/bundle.min.js', 'modules/warehouse/static/js/plugins', 'modules/warehouse/static/js/browse'], { base: __dirname })
            .pipe(concat('browse.min.js'))
            .pipe(gulp.dest(path.join('modules', 'warehouse', 'static', 'js')))
            .on('end', resolve);
    });
    fs.unlinkSync(path.join(__dirname, 'modules', 'warehouse', 'static', 'js', 'browse'));
    ...
    await new Promise((resolve) => {
        gulp.src(['static/zoia/core/js/jquery.zoiaFormBuilder.js', 'static/zoia/core/js/jquery.zoiaTable.js', 'modules/warehouse/static/js/warehouse.js'], { base: __dirname })
            .pipe(babel({
                presets: ['env']
            }))
    ...
    await new Promise((resolve) => {
        gulp.src(['static/zoia/3rdparty/jstree/jstree.min.js', 'modules/warehouse/static/js/plugins', 'modules/warehouse/static/js/warehouse'], { base: __dirname })
